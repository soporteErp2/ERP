	...
	class ApiRemisiones
	{
		...
		public function store($data=NULL){
        	...
        	if ($query){
    			...
    			$updateInventario = $this->updateInventario($id_remision,'salida',"Generar");
		...
		public function update($data=NULL){
        	...
        	if ($query){
    			...
    			$updateInventario = $this->updateInventario($id_documento,'salida',"Generar");
    			if ($updateInventario['status']==false) { return array('status'=>false,'detalle'=>$updateInventario['detalle']); }
    	 ...
    	 */
    	public function updateInventario($id_documento,$accion_inventario,$accion_documento){
			$arrayUbicaciones = $this->getSucursales();
		...
		public function rollBack($id_remision,$nivel, $sentencia = NULL){
			...
			if ($nivel>=2){
				$updateInventario = $this->updateInventario($id_remision,'"reversar salida',"Editar");
