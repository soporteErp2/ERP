<?php
	...
	$sql="SELECT COUNT(id) AS cont FROM ventas_facturas WHERE activo=1 AND id_empresa=$id_empresa AND response_FE LIKE '%Ejemplar recibido exitosamente pasara a verificacion%'";
	$query=$mysql->query($sql,$mysql->link);
	$contFE = $mysql->result($query,0,'cont');
