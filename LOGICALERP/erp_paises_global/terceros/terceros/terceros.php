<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		///DIRECCION PRINCIPAL
			...
			$grilla->AddComboBox ("$labelDepto",'id_departamento',200,'true','true','ubicacion_departamento,id,departamento,true','activo = 1 AND id_pais=49 ORDER BY departamento ASC');
			$grilla->AddComboBox ("$labelCiudad",'id_ciudad',200,'true','true','ubicacion_ciudad,id,ciudad,true','activo = 1 ORDER BY ciudad ASC');
