<?php
    ...
    function contabilizarSinPlantillaNiif($arrayCuentaPago,$fechaInicioFactura,$consecutivoFactura,$idBodega,$idSucursal,$idEmpresa,$idFactura,$idProveedor,$link){
		...
		foreach ($arrayInventarioFactura AS $valArrayInventario) {
			...
			$cuentaPrecio   = (strlen($descripcionCuenta) > 4)? $cuentaOpcional: $arrayCuentasItems[$idItemArray]['precio']['cuenta'];
