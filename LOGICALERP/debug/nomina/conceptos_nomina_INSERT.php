<?php
	...
	$id_empresa=2;
	exit;
	// $sql="SELECT * FROM asientos_colgaap";
	...
	while ($row=mysql_fetch_array($query)) {
		...
		$arrayConceptos['GENERAL']['SB']	  = array(
													...
													'carga_automatica'             => 'true',
													'nivel_formula'                => 2,
													'formula'                      => '({SC} /30)*({DL}-(30*[DS] /{SC})-(30*[IM]  /{SC})-(30* [AP] /{SC})-(30*[LM]  /{SC}))',
													'tipo_concepto'                => 'Personal',
													'tercero'                      => 'Empleado',
													'tercero_cruce'                => 'Empleado',
													'resta_dias'                   => 'false'
		...
		$arrayConceptos['SEGURIDAD SOCIAL']['PE']	= array(
														...
														'carga_automatica'             => 'true',
														'nivel_formula'                => 2,
														'formula'                      => '(((({SC} /30)*({DL}-(30*[DS] /{SC})-(30* [AP] /{SC})-(30*[LM]  /{SC})-(30*[IM]  /{SC})-(30*[PNR] /{SC})))+[HDFCD] +[IM] + [HENF] +[HDFSD] +[RN] +[HEDO] +[HENO] +[HEDF]+ [CM] )-[PNR]- [DS]- [AP] )*0.12',
														'tipo_concepto'                => 'General',
														'tercero'                      => 'Entidad',
														'tercero_cruce'                => 'Entidad',
														'resta_dias'                   => 'false'
		...
		$arrayConceptos['PARAFISCALES']['CDCF']	= array(
																	...
																	'carga_automatica'             => 'true',
																	'nivel_formula'                => 1,
																	'formula'                      => '(({SC} /30)*({DL}-(30*[DS] /{SC})-(30* [AP] /{SC})-(30*[LM]  /{SC})-(30*[IM]  /{SC})-(30*[PNR] /{SC}))) *0.04',
																	'tipo_concepto'                => 'General',
																	'tercero'                      => 'Entidad',
																	'tercero_cruce'                => 'Entidad',
																	'resta_dias'                   => 'false'
		...
		$arrayConceptos['CARGA PRESTACIONAL']['CS']		= array(
															...
															'carga_automatica'             => 'true',
															'nivel_formula'                => 5,
															'formula'                      => '((({SC}+74000)*( {DL}-(30*[DS] /{SC})-(30* [AP] /{SC})-(30*[PNR] /{SC})) )+[HDFCD]+[HENF]+[HDFSD]+[RN]+[CM]+[HEDO]+[HENO]+[HEDF] + [MT])/360',
		...
		$arrayConceptos['CARGA PRESTACIONAL']['ISC']	= array(
															...
															'carga_automatica'             => 'true',
															'nivel_formula'                => 6,
															'formula'                      => '([CS] *({DL}-(30*[DS] /{SC})-(30* [AP] /{SC})-(30*[PNR] /{SC})))/3000',
															'nivel_formula_liquidacion'    => '2',
															'formula_liquidacion'          => '([CS] *{DL} *0.12)/360',
															'tipo_concepto'                => 'General',
															'tercero'                      => 'Empleado',
															'tercero_cruce'                => 'Empleado',
															'resta_dias'                   => 'false'
		...
		$arrayConceptos['CARGA PRESTACIONAL']['VC']		= array(
															...
															'carga_automatica'             => 'true',
															'nivel_formula'                => 3,
															'formula'                      => '(({SC}+ [MT])  *({DL}-(30*[DS] /{SC})-(30* [AP] /{SC})-(30*[PNR] /{SC})) )/720',
															'nivel_formula_liquidacion'    => '1',
