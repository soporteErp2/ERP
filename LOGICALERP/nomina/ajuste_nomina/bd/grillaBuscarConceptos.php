<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_empresa = $id_empresa AND concepto_ajustable='true' AND id NOT IN (
												SELECT id_concepto AS id
												FROM nomina_planillas_ajuste_empleados_conceptos
												WHERE  id_empresa=$id_empresa AND id_planilla=$id_planilla AND id_empleado=$id_empleado)";		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
