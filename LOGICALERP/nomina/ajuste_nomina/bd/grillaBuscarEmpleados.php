<?php
	...
	$sql="SELECT id_empleado  FROM nomina_planillas_ajuste_empleados WHERE activo=1 AND id_empresa=$id_empresa AND id_planilla=$id_planilla";
	$query=mysql_query($sql,$link);
	$whereId=' AND id_empleado<>0 ';
	while ($row=mysql_fetch_array($query)) {
		$whereId.=' AND id_empleado<>'.$row['id_empleado'];
	}

	$where=($sql_estado=='')? 'estado=0' : 'estado=1'  ;
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_empresa = $id_empresa AND id_sucursal=$filtro_sucursal AND $where AND fecha_inicio_nomina<='$fecha_final'  AND nombre_empleado IS NOT NULL $whereId";		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRowImage('Estado','<center><img src="img/estado_doc/contrato_[estado].png" id="imgEstado_[id]"  style="cursor:pointer" width="16" height="16"/></center>','50');
