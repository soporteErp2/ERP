<?php
    ...
    // $sql="SELECT id_planilla FROM nomina_electronica_empleados WHERE activo=1 AND id_empresa=$empresa GROUP BY id_planilla";
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'nomina_planillas_electronica';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nomina_planillas_electronica';		//NOMBRE DE LA TABLA DE CONSULTA EN LA BASE DE DATOS DE
			$grilla->MyWhere			= 'activo = 1 AND id_empresa='.$empresa.' ';		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
            ...
            $grilla->AddRow('Tipo Documento','codigo_tipo_documento',100);
...
if(!isset($opcion)){ ?>
    ...
    <?php if(!isset($VBarraBotones)){ ?>
        <script>
            ...
            var toolbar = Ext.getCmp('ToolBar_nomina_planillas_electronica').getTopToolbar();
                    ...
                    items: [
                        {
                            ...
                            handler   : function(){BloqBtn(this); Editar_nomina_planillas_electronica();}
                        },
                    ]
                }
	...
	<script>
		...
		function Editar_nomina_planillas_electronica(id){
			AbreVentanaGrillaPlanillaElectronica(id);
		}

		function Agregar_nomina_planillas_electronica (argument) {
			AbreVentanaGrillaPlanillaElectronica('');
		}

		Ext.QuickTips.init();
		
		//ABRIR LA VENTANA PARA AGREGAR O EDITAR LA PLANILLA
    	function AbreVentanaGrillaPlanillaElectronica(id_planilla){
    		var opcGrillaContable='PlanillaElectronica';
            var  direccionRender = 'nomina_electronica/grillaPlanilla.php';
            if (id_planilla>0) {
                ...
                var  direccionRender = (estado=='1' || estado=='3')? 'nomina_electronica/bd/grillaContableBloqueada.php' : 'nomina_electronica/grillaPlanilla.php' ;
            }
                            ...
                            },
                            {
                                ...
                                [

                                    {
                                        ...
                                        iconCls     : 'cancel',
                                        iconAlign   : 'top',
                                        handler     : function(){ BloqBtn(this); cancelarPlanilla_nomina_electronica(); }
                                    }
                                ]
                            },'-',
                            {
                                ...
                                [
                                    ...
                                    // },
                                    {
                                        ...
                                        iconAlign   : 'top',
                                        hidden : false,
                                        handler     : function(){ BloqBtn(this); editarPlanilla_nomina_electronica(); }
                                    },
                                    // {
                                    //     xtype       : 'button',
