<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= "nomina_planillas_electronica_empleados_fechas_pago";  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nomina_planillas_electronica_empleados_fechas_pago';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
			$grilla->MyWhere			= "activo = 1 AND id_empresa='$id_empresa' AND id_planilla=$id_planilla AND id_empleado=$id_empleado ";
...
<?php
	...
	<script>
	    ...
	    allowBlank : false,
	    showToday  : false,
	    applyTo    : 'nomina_planillas_electronica_empleados_fechas_pago_fecha',
