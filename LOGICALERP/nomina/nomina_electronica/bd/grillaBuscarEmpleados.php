<?php
	...
	$sql="SELECT fecha_inicio,fecha_final FROM nomina_planillas_electronica WHERE activo=1 AND id_empresa=$id_empresa AND id=$id_planilla";
	...
	$sql="SELECT id_empleado FROM nomina_planillas_electronica_empleados WHERE activo=1 AND id_empresa=$id_empresa AND id_planilla=$id_planilla";
	$query=mysql_query($sql,$link);
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_empresa = $id_empresa AND id_sucursal=$filtro_sucursal AND fecha_inicio_nomina<='$fecha_final'  AND nombre_empleado IS NOT NULL $whereId";		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
