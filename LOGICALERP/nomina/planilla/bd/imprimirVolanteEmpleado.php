<?php
	...
	$sql = "SELECT id_empleado,id_contrato,dias_laborados,terminar_contrato,observaciones
	...
	$sql = "SELECT id_empleado,id_contrato,id_concepto,concepto,valor_concepto,naturaleza,valor_campo_texto
	...
	$contenido = '<table class="articlesTable">
					<thead>
						<tr>
							...
							<td style="width:17%; text-align:right;"><b>DEVENGO</b></td>
							<td style="width:17%; text-align:right;"><b>DEDUCCION</b></td>
						</tr>
					</thead>
					<tbody>
						'.$conceptos.'
