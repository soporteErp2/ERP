<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRowImage('Estado','<center><img src="img/estado_doc/[estado].png" id="imgEstado_[id]"  style="cursor:pointer" width="16" height="16"/></center><input type="hidden" id="estado_[id]" value="[estado]">','50');
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
            ...
            // $grilla->AddBotton("Nueva Planilla","edit","habilitar_empleados_en_vacaciones(); Agregar_nomina_planillas();");
...
if(!isset($opcion)){ ?>
    ...
    <?php if(!isset($VBarraBotones)){ ?>
        <script>
            var permisoBtn_nomina_planillas = <?php echo user_permisos(96,'true') ?>;
            var toolbar = Ext.getCmp('ToolBar_nomina_planillas').getTopToolbar();
                    ...
                    items: [
                        {
                            ...
                            disabled  : permisoBtn_nomina_planillas,
                            handler   : function(){BloqBtn(this); habilitar_empleados_en_vacaciones(); Agregar_nomina_planillas();}
                        },
                    ]
                }
	...
	<script>
    	...
    	function AbreVentanaGrillaPlanilla(id_planilla){
            ...
            if (id_planilla>0) {
                ...
                var  estado          = document.getElementById('estado_'+id_planilla).value
                var  direccionRender = (estado=='1' || estado=='3' || estado=='2')? 'planilla/bd/grillaContableBloqueada.php' : 'planilla/grillaPlanilla.php' ;
            }
