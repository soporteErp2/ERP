<?php
	...
	$sql="SELECT id,id_empleado,documento_empleado,nombre_empleado,numero_contrato,grupo_trabajo,fecha_inicio_contrato,tipo_contrato
	...
	$sql="SELECT id_empleado,id_contrato,id_concepto,concepto,valor_concepto,valor_concepto_ajustado,naturaleza,dias_laborados,base
