<?php
    ...
    $sql="SELECT id_planilla FROM nomina_planillas_consolidacion_provision_empleados WHERE activo=1 AND id_empresa=$empresa GROUP BY id_planilla";
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'nomina_planillas_consolidacion_provision';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nomina_planillas_consolidacion_provision';		//NOMBRE DE LA TABLA DE CONSULTA EN LA BASE DE DATOS DE
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
            $grilla->AddRow('Fecha','fecha_documento',100);
...
if(!isset($opcion)){ ?>
    ...
    <?php if(!isset($VBarraBotones)){ ?>
        <script>
            var permisoBtn_liquidacion_planillas = <?php echo user_permisos(101,'true') ?>;
            var toolbar = Ext.getCmp('ToolBar_nomina_planillas_consolidacion_provision').getTopToolbar();
                    ...
                    items: [
                        {
                            ...
                            handler   : function(){BloqBtn(this); habilitar_empleados_en_vacaciones(); Editar_nomina_planillas_consolidacion_provision();}
                        },
                    ]
                }
	...
	<script>
		...
		function Editar_nomina_planillas_consolidacion_provision(id){
			AbreVentanaGrillaPlanillaConsolidacionProvision(id);
		}

		function Agregar_nomina_planillas_consolidacion_provision (argument) {
			AbreVentanaGrillaPlanillaConsolidacionProvision('');
		}


		//ABRIR LA VENTANA PARA AGREGAR O EDITAR LA PLANILLA
    	function AbreVentanaGrillaPlanillaConsolidacionProvision(id_planilla){
    		var opcGrillaContable='PlanillaConsolidacionProvision';
            var  direccionRender = 'consolidacion_provision/grillaPlanilla.php';
            if (id_planilla>0) {
                var  estado          = document.getElementById('imgEstado_'+id_planilla).getAttribute('src')
                var  direccionRender = (estado=='img/estado_doc/1.png' || estado=='img/estado_doc/3.png')? 'consolidacion_provision/bd/grillaContableBloqueada.php' : 'consolidacion_provision/grillaPlanilla.php' ;
            }
        	...
        	Win_ventana_planilla = new Ext.Window({
                width       : WinAncho,
                height      : WinAlto,
                title       : 'Planilla de Consolidacion de Provision',
                modal       : true,
                autoScroll  : false,
                autoDestroy : false,
                closable    : false,
                            ...
                            },
                            {
                                ...
                                [

                                    {
                                        ...
                                        iconCls     : 'cancel',
                                        iconAlign   : 'top',
                                        handler     : function(){ BloqBtn(this); cancelarPlanillaConsolidacionProvision(); }
                                    }
                                ]
                            },'-',
                            {
                                ...
                                [
                                    {
                                        ...
                                        iconCls     : 'pdf32_new',
                                        iconAlign   : 'top',
                                        handler     : function(){ BloqBtn(this); imprimirPlanillaConsolidacionProvision(); }
                                    ...
                                    },
                                    {
                                        ...
                                        iconAlign   : 'top',
                                        hidden : false,
                                        handler     : function(){ BloqBtn(this); modificarDocumentoPlanillaConsolidacionProvision(); }
                                    },
                                    {
                                        xtype       : 'button',
                                        ...
                                        iconCls     : 'restaurar32',
                                        iconAlign   : 'top',
                                        handler     : function(){ BloqBtn(this); restaurarPlanillaConsolidacionProvision(); }
                                    }
                                ]
                            },
                            {
