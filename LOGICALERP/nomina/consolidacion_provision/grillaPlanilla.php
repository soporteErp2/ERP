...
<?php
    ...
    $dias_liquidacion='';
    $tipo_liquidacion='<select id="id_tipo_liquidacion" onchange="UpdateTipoConsolidacionProvision(this.value)">';
    ...
    if($id_planilla==''){
        ...
        $acumScript .=  'new Ext.form.DateField({
                        ...
                        document.getElementById("planilla_saldo_inicial").value ="false";
                        Inserta_Div_nomina_planillas_consolidacion_provision('.$id_planilla.');';
    }
    //============================ SI EXISTE LA PLANILLA =============================//
        ...
        if ($consecutivo!='') {
            $acumScript.='document.getElementById("titleDocumento'.$opcGrillaContable.'").innerHTML="Planilla de Consolidacion <br>N. '.$consecutivo.'";';
        }
        ...
        $acumScript .=  '
                        ...
                        document.getElementById("planilla_saldo_inicial").value ="'.$saldo_inicial.'";
        ...
        $sql="SELECT id_empleado,documento_empleado,nombre_empleado,id_contrato,verificado FROM nomina_planillas_consolidacion_provision_empleados WHERE activo=1 AND id_empresa=$id_empresa AND id_planilla=$id_planilla";
        $query=mysql_query($sql,$link);
        $bodyEmpleados='';
        $cont=1;
        while ($row=mysql_fetch_array($query)) {
            ...
            <div class="contTopFila">
                ...
                <div class="renglonTop">
                    <div class="labelTop">
                        ...
                        <div id="divTitle"> <table><tr><td>La planilla saldo inicial no genera contabilidad, solo la referencia de la cuenta para cruzarla en otros documentos</td></tr></table> </div>
                        <div id="divLoadTipoPlanilla" style="float: right;width: 20px;height: 16px;margin-top: -2;overflow:hidden;"></div></div>
                    <div class="campoTop">
                        <select id="planilla_saldo_inicial" onchange="UpdateTipoPlanilla<?php echo $opcGrillaContable; ?>(this.value)">
            ...
            <div class="contenedor_totales">
                ...
                <div class="contenedorConceptos" style="height:auto;margin-top:10px;width:auto;">
                    <div class="bodyDivNominaPlanilla" style="background-color:#FFF;">
                        <div class="campoHeadConceptos" style="text-align: center;background-color : #F3F3F3;border-right:none;width:calc(100% - 20px);">TOTAL CONSOLIDACION</div>
...
<script>
    ...
    function UpdateTipoPlanilla<?php echo $opcGrillaContable; ?>(saldo_inicial){
        var empleados = document.querySelectorAll('.claseBuscar');

        if (empleados.length>0) {
            if (!confirm("Hay empleados guardados en esta planilla, si cambia el tipo de planilla se eliminaran\nDesea continuar?")) {
                document.getElementById('planilla_saldo_inicial').value=(saldo_inicial=='true')? 'false' : 'true' ;
                return;
            }
        }

        Ext.get('divLoadTipoPlanilla').load({
            url     : 'consolidacion_provision/bd/bd.php',
            scripts : true,
            nocache : true,
            params  :
            {
                opc           : 'cambiarTipoPlanilla',
    ...
    function UpdateTipoConsolidacionProvision(valor){
                            ...
                            [
                                {
                                    ...
                                    autoLoad    :
                                    {
                                        ...
                                        {
                                            renderizaBody : 'true',
                                            url_render    : 'consolidacion_provision/bd/grillaBuscarEmpleados.php',
                                            opc           : 'buscar_empleado',
    ...
    function ventanaBuscarConceptos(cont) {
        ...
        // var id_contrato = document.getElementById('id_contrato_concepto_'+cont).value;
         ...
         Win_Ventana_bucar_concepto = new Ext.Window({
             ...
             autoLoad    :
             {
                 url     : 'consolidacion_provision/bd/grillaBuscarConceptos.php',
                 scripts : true,
                 nocache : true,
                 params  :
                 {
    ...
    function ventanaBuscarConceptosConceptoDeduccion(cont,id_empleado,id_contrato) {
        Win_Ventana_ventana_buscar_concepto = new Ext.Window({
                ...
                autoLoad    :
                {
                    url     : 'consolidacion_provision/bd/buscar_concepto.php',
                    scripts : true,
                    nocache : true,
                    params  :
                    {
    ...
    //=================== BUSCAR LOS CONCEPTOS QUE SE VAN A DEDUCIR DEL PRESTAMO ================//
    function ventanaBuscarConceptosVacaciones(id_empleado,id_contrato) {
        Win_Ventana_ventana_buscar_concepto = new Ext.Window({
                width       : 500,
                height      : 400,
                id          : 'Win_Ventana_ventana_buscar_concepto',
    ...
    function responseVentanaBuscarConceptoVacaciones(id){
        var concepto    = document.getElementById('div_grilla_buscar_conceptos_concepto_'+id).innerHTML;
        var id_concepto = document.getElementById('id_concepto_buscar_'+id).value;

        document.getElementById('id_concepto_vacaciones').value = id_concepto;
    ...
    function calculaValorVacacionesDisfrutadas(dias,id_empleado,id_contrato,op){

        var id_input = (op=='compensadas')? 'valor_vacaciones_compensadas' : 'valor_vacaciones_disfrutadas';
        var divLoad  = (op=='compensadas')? 'divLoadValorVacacionesCompensadas' : 'divLoadValorVacacionesDisfrutadas';

        var base_vacaciones = document.getElementById('base_vacaciones').value;
        var id_concepto_vacaciones = document.getElementById('id_concepto_vacaciones').value;
    ...
    function validarPlanillaConsolidacionProvision(){
    ...
    function guardarPlanilla(){
        ...
        var validaPlanilla=validarPlanillaConsolidacionProvision();
        ...
        cargando_documentos('Generando Planilla de<br> Consolidacion de Provision...','');
    ...
    function cancelarPlanillaConsolidacionProvision(){
        ...
        cargando_documentos('Cancelando Planilla de<br> Consolidacion de Provision...','');
        Ext.get('render_btns_PlanillaConsolidacionProvision').load({
            url     : 'consolidacion_provision/bd/bd.php',
            scripts : true,
            nocache : true,
