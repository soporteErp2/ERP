<?php
	...
	$sql="SELECT id_empleado,id_contrato,id_concepto,concepto,valor_concepto,naturaleza FROM nomina_planillas_empleados_conceptos WHERE activo=1  AND id_planilla=$id_planilla AND imprimir_volante='true' AND ($whereIdConceptos) ORDER BY naturaleza ASC";
	$query=mysql_query($sql,$link);
	$conceptos     ='';
	$acumDevengo   =0;
	$acumDeduccion =0;
