...
.div_input_busqueda_grilla_manual{float: right;}
.div_img_actualizar_datos_grilla_manual{ float: right;}
    ...
    <div class="bodyArticulos" id="bodyArticulos<?php echo $opcGrillaContable; ?>">
        <div class="renderFilasArticulo" id="renderizaNewArticulo<?php echo $opcGrillaContable; ?>">
            <div class="contenedorEmpleados" >
                ...
                <div class="div_img_actualizar_datos_grilla_manual" style="border-top:none;  height: 33px;border-bottom:1px solid #D4D4D4;">
                    <img src="img/reload_grilla.png" onclick="buscarEmpleadoCargado();" title="Actualizar">
                </div>
                <div class=" div_input_busqueda_grilla_manual" style="border-top:none;">
...
<script>
    ...
    function cerrarPlanilla(){
        ...
        Actualiza_Div_nomina_planillas(<?php echo $id_planilla ?>);
    }
