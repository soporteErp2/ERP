<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//TAMANO DE LA GRILLA
			...
			// $grilla->QuitarAncho		= 500;				//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ANCHO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true'
			// $grilla->QuitarAlto			= 600;				//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ALTO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true'
...
if(!isset($opcion)){  ?>
	<script>
		...
		function Agregar_centroCostos(){ }
		function Editar_centroCostos(id){ <?php echo $cargaFuncion; ?> }
