<?php
    ...
    function validateConsecutivo($opcGrillaContable,$id_empresa,$link){
        $sqlValidateConsecutivo = "SELECT VFC.numero_inicial_resolucion AS inicial_r,
                                                VFC.numero_final_resolucion AS final_r,
                                                CCD.consecutivo
                                        FROM ventas_facturas_configuracion AS VFC,
                                            configuracion_consecutivos_documentos AS CCD
                                        WHERE VFC.id_empresa='$id_empresa'
                                            AND VFC.activo=1
                                            AND CCD.id_empresa = VFC.id_empresa
                                            AND CCD.documento = 'factura_venta'
                                        ORDER BY VFC.id DESC
                                        LIMIT 0,1";
...
<?php
    ...
    if(isset($idConsecutivoCotizacionPedido)){
        ...
        //TABLA CRUCE
        $sqlConsulOrden = "SELECT id,nit,id_cliente,cod_cliente,cliente,observacion,documento_vendedor,nombre_vendedor $campoCarga $whereCcos
                            FROM $tablaCarga
                            WHERE consecutivo   ='$idConsecutivoCotizacionPedido'
        ...
        $observacion_cotizacion = mysql_result($queryConsulOrden,0,'observaciones');
        ...
        $sqlInsertFactura   = "INSERT INTO $tablaPrincipal(id_empresa,random,nit,id_cliente,cod_cliente,cliente,fecha_inicio,id_sucursal,id_bodega,observacion,documento_vendedor,nombre_vendedor,id_forma_pago,dias_pago,forma_pago,id_configuracion_cuenta_pago,configuracion_cuenta_pago,cuenta_pago,cuenta_pago_niif,id_centro_costo,centro_costo,codigo_centro_costo,id_sucursal_cliente,sucursal_cliente)
                                VALUES('$id_empresa','$random_factura','$nit','$id_cliente','$cod_cliente','$cliente','$fecha','$id_sucursal','$filtro_bodega','$observacion_cotizacion','$documento_vendedor','$nombre_vendedor','$idFormaPago','$diasFormaPago','$nombreFormaPago','$idConfigCuentaPago','$configuracionCuentaPago','$CuentaPago','$CuentaPagoNiif','$idCcos','$nombreCcos','$codigoCcos','$idSucursalCliente','$sucursal_cliente')";
    ...
    //============================================ SI NO SE CARGA DOCUMENTO DE REFERENCIA PREVIO ===================================================
        ...
        $sqlInsert   = "INSERT INTO $tablaPrincipal (id_empresa,random,fecha_inicio,id_sucursal,id_bodega,documento_vendedor,nombre_vendedor,id_forma_pago,dias_pago,forma_pago,id_configuracion_cuenta_pago,configuracion_cuenta_pago,cuenta_pago,cuenta_pago_niif,id_usuario)
                        VALUES('$id_empresa','$random_factura','$fecha','$id_sucursal','$filtro_bodega','".$_SESSION['CEDULAFUNCIONARIO']."','".$_SESSION['NOMBREFUNCIONARIO']."','$idFormaPago','$diasFormaPago','$nombreFormaPago','$idConfigCuentaPago','$configuracionCuentaPago','$CuentaPago','$CuentaPagoNiif','$id_usuario')";
    ...
    while($rowDocReferencia = mysql_fetch_array($queryDocReferencia)){
        ...
        $acumDocReferencia .= '<div style="width:136px; '.$margin_left.'; float:left; overflow:hidden;height: 22px;" id="divDocReferenciaFactura_'.$rowDocReferencia['doc_referencia'].'_'.$rowDocReferencia['id_referencia'].'">
                                    ...
                                    <div title="'.$title.' # '.$rowDocReferencia['cod_referencia'].' en la presente factura" onclick="eliminaDocReferenciaFactura(\''.$rowDocReferencia['id_referencia'].'\',\''.$rowDocReferencia['doc_referencia'].'\',\''.$id_factura_venta.'\')" style="float:left; width:18px; height:18px; margin:1px 0 0 -22px; background-image: url(img/MyGrillaFondo.png); border: 1px solid #d4d4d4;">
    ...
    //============================================ SELECT ANTICIPO CLIENTE =================================================//
    if($id_cliente > 0){
        $sqlAnticipo   = "SELECT SUM(debe-haber) AS saldo_anticipo
                            FROM asientos_colgaap
                            WHERE activo=1 AND id_empresa='$id_empresa' AND id_tercero='$id_cliente' AND LEFT(codigo_cuenta,4)=2805 GROUP BY codigo_cuenta";
        ...
        <div class="contInfoFact">
            ...
            <div class="contTopFila">
                <div class="renglonTop">
                    ...
                    <div class="iconBuscarProveedor" onclick="abrirVentanaUpdateFecha<?php echo $opcGrillaContable; ?>(this)" title="Editar Fecha">
                ...
                <div class="renglonTop" id="checksRetenciones<?php echo $opcGrillaContable; ?>">
                    <div class="labelTop" ><div id="renderCheck" style="margin-left:0px;" class="renderCheck" ></div>Retenciones <img src="img/config16.png" style="float:right;cursor:pointer;margin: 0 3 0 0;width: 14;height: 14;" onclick="ventanaConfigurarRetenciones<?php echo $opcGrillaContable; ?>()" title="Configurar Retenciones" /></div>
                ...
                <!-- <div class="renglonTop">
                    <div class="labelTop">Anticipo Cliente</div>
                    <div class="campoTop"><input type="text" id="anticipo_cliente_<?php echo $opcGrillaContable; ?>" value="<?php echo $anticipoCliente ?>" readonly="readonly"/></div>
                    <div class="iconBuscarProveedor" onclick="abrirVentanaCuentaAnticipo<?php echo $opcGrillaContable; ?>()" title="Valor anticipo">
                       <img src="img/config16.png" style="margin: 2px 0 0 2px;"/>
                    </div>
                </div> -->
            </div>
...
<script>
   ...
   document.getElementById('fecha<?php echo $opcGrillaContable; ?>').style.overflow='hidden !important';
    ...
    function guardarNewArticulo<?php echo $opcGrillaContable; ?>(cont){
        ...
        else if(cantArticulo < 1 || cantArticulo == ''){document.getElementById('cantArticulo<?php echo $opcGrillaContable; ?>_'+cont).blur(); alert('El campo Cantidad es obligatorio'); setTimeout(function(){ document.getElementById('cantArticulo<?php echo $opcGrillaContable; ?>_'+cont).focus(); },100);  return; }
    ...
    function abrirVentanaCuentaAnticipo<?php echo $opcGrillaContable; ?>(){
            ...
            [
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            iconAlign   : 'top',
                            disabled    : true,
                            handler     : function(){ cancelarAnticipoFactura_<?php echo $opcGrillaContable; ?>(); }
                        }
                    ]
                }
            ]
