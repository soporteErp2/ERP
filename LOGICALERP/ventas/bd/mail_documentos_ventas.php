<?php
    ...
    */
	...
	$sql            = "SELECT id_cliente,cliente FROM $tabla WHERE id = '$id'";
	$con_cliente    = mysql_query($sql,$link);
	$id_cliente     = mysql_result($con_cliente,0,"id_cliente");
	$nombre_cliente = mysql_result($con_cliente,0,"cliente");
