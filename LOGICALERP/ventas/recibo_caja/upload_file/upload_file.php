...
class qqFileUploader {
  ...
  function handleUpload($uploadDirectory,$id_documento,$id_empleado){
    ...
    if($id_recibo_caja != 0){
      $sqlInsertDocumento = "INSERT INTO ventas_recibo_caja_documentos (id_recibo_caja, nombre, ext, id_usuario, fecha) VALUES ('$id_recibo_caja','$filename','$ext','$id_usuario',NOW())";
    }
...
$ruta3 = $serv.'ARCHIVOS_PROPIOS/empresa_'.$id_host.'/ventas/recibo_caja';
$url   = $ruta3.'/';
