<?php
	...
	if(isset($responseWs['inv_identification'])){ $responseWs = array(0 => $responseWs); }
	else if(!isset($responseWs[0]['inv_identification'])){ response_error(array("estado"=>"error", "msj"=>"No hay terceros por sincronizar para el dia ".fecha_larga($fecha_metodo)),true); return; }

	foreach ($responseWs as $i => $arrayWsTercero) {

		list($nit,$dv) = explode('-', $arrayWsTercero['inv_identification']);
		$nit = str_replace('.', '', $nit);

		$arrayWs['tercero']['nombre']                       = $arrayWsTercero['Column1'];
		$arrayWs['tercero']['nombre_comercial']             = $arrayWsTercero['Column1'];
		$arrayWs['tercero']['codigo_tipo_identificacion']   = $arrayWsTercero['Column6'];
		$arrayWs['tercero']['numero_identificacion']        = $nit;
		$arrayWs['tercero']['dv']                           = $dv;
		$arrayWs['tercero']['codigo_ciudad_identificacion'] = $arrayWsTercero['Column6'];
		$arrayWs['tercero']['codigo_ciudad']                = $arrayWsTercero['Column6'];
		$arrayWs['tercero']['codigo_regimen']               = $arrayWsTercero['Column10'];
		$arrayWs['tercero']['direccion']                    = $arrayWsTercero['Column2'];
		$arrayWs['tercero']['cliente']                      = 'si';
		$arrayWs['tercero']['proveedor']                    = 'si';
		$arrayWs['tercero']['celular1']                     = $arrayWsTercero['Column8'];
	...
	function insertUpdateTerceroEmpresa($arrayWs,$idEmpresaErp,$link){
		...
		else{ response_error(array("estado"=>"error", "msj"=>"Codigo de ubicacion ciudad no valido Tercero ".$infoTercero['numero_identificacion']." ".$infoTercero['nombre']),false); return; }
		...
		if($arrayUbicacion["estado"] == "true"){ $idTipoNitTercero = $arrayTipoDocumento['id']; }
