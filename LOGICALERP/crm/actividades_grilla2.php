<?php 
	...
	/**/											/**/
	/**//////////////////////////////////////////////**/
	//echo 'activo = 1 AND id_objetivo = '.$id_objetivo.' AND id_cliente = '.$id_cliente;

	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		//NOMBRE DE LA GRILLA
 			$grilla->GrillaName	 		= 'Actividades2';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
  		//QUERY
			$grilla->TableName			= 'crm_objetivos_actividades';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS 
 			$grilla->MyWhere			= 'activo = 1 AND id_objetivo = '.$id_objetivo.' AND id_cliente = '.$id_cliente;		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//TAMANO DE LA GRILLA 
			...
			$grilla->QuitarAncho		= 115;				//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ANCHO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true' 
			$grilla->QuitarAlto			= 285;				//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ALTO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true' 
		...
		//OPCIONES ADICIONALES EN EL MENU CONTEXTUAL
 			...
 			$grilla->AddMenuContext('Finalizar Actividad','ok16','FinalizaActividad([id],"Actividades2");');
 ...
 ?>
 	...
 	<script>
 		...
 		function Agregar_Actividades2(){
			VentanaActi1 = 0; VentanaActi2 = 1;
 			Agregar_ActividadesTareas(<?php echo $id_objetivo ?>);	
 		}

 		function Editar_Actividades2(id){
			VentanaActi1 = 0; VentanaActi2 = 1;
