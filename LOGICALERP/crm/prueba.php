...
?>
	...
	<!--<script src="../../misc/clockpicker/bootstrap.min.js" type="text/javascript"></script>-->
...
<html>
<body>
<input id="ActividadHora" type="text" class="MyField clockpicker" style="width:100px;" ></div>

</body>
</html>

<script>
	var input = $('#ActividadHora');
	input.clockpicker({
		autoclose: true
	});
</script>