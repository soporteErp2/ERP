...
?>
	...
	<div id="ToolbarTareas">
    	...
    	<div style="float:left; width:350px; font-size:20px; margin:0 0 0 0;">Programaci&oacute;n de Actividad<br /><span style="font-size:12px"><?php echo fecha_larga($fecha)?></span></div>
