<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'TiposLquidacion';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nomina_tipo_contrato';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//TOOLBAR Y CAMPO DE BUSQUEDA
			...
			$grilla->CamposBusqueda		= 'id,descripcion,dias';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
			$grilla->DivActualiBusqueda = '' ;				//VARIABLE QUE DEFINE LA CAPA DONDE SE ACTUALIZA LA GRILLA DESPUES DE UNA BUSQUEDA

		//CONFIGURACION DE CAMPOS EN LA GRILLA
			$grilla->AddRow('Descripcion','descripcion',200);
			$grilla->AddRow('Dias','dias',80);
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->TituloVentana		= 'Tipos de Contrato'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
			$grilla->VBarraBotones		= 'true';			//SI HAY O NO BARRA DE BOTONES
			$grilla->VBotonNuevo		= 'true';			//SI LLEVA EL BOTON DE AGREGAR REGISTRO
			$grilla->VBotonNText		= 'Nuevo <br/>Tipo de Contrato'; //TEXTO DEL BOTON DE NUEVO REGISTRO
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddTextField('Dias','dias',150,'true','false');
			$grilla->AddValidation('dias','numero');
...
if(!isset($opcion)){ ?>
	<script>
		var styleGrilla = document.getElementById('ContenedorPrincipal_TiposLquidacion').getAttribute('style');
		document.getElementById('ContenedorPrincipal_TiposLquidacion').setAttribute('style', styleGrilla+'; margin-top:10px;')
	</script>
<?php
} ?>