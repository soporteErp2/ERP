...
<?php
    ...
    //CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //NOMBRE DE LA GRILLA
            $grilla->GrillaName         = 'items_terminos';      //NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
        //QUERY
            $grilla->TableName          = 'items_terminos';      //NOMBRE DE LA TABLA EN LA BASE DE DATOS
        ...
        //CONFIGURACION DE CAMPOS EN LA GRILLA
            ...
            $grilla->AddRowImage('Terminos','<center><img src="img/config16.png" onclick="ventanaTerminoDetalle([id])" title="Configurar terminos" style="cursor:pointer;" ></center>',60);
        ...
        //CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
            ...
            $grilla->TituloVentana      = 'Grupo de terminos'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
...
//
	...
	if(!isset($opcion)){ ?>
	    <script>
	    	var ventanaTerminoDetalle = (id_termino)=>{

	    		Win_Ventana_termino_detalle = new Ext.Window({
	    		    width       : 400,
	    		    height      : 350,
	    		    id          : 'Win_Ventana_termino_detalle',
	    		    title       : 'Configurar los terminos',
	    		    modal       : true,
	    		    autoScroll  : false,
	    		    closable    : false,
	    		    autoDestroy : true,
	    		    autoLoad    :
	    		    {
	    		        url     : 'items_terminos/terminos_detalle.php',
	    		        scripts : true,
	    		        nocache : true,
	    		        params  :
	    		        {
