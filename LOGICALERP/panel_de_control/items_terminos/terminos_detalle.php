...
<?php
    ...
    //CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //NOMBRE DE LA GRILLA
            $grilla->GrillaName         = 'items_terminos_detalle';      //NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
        //QUERY
            $grilla->TableName          = 'items_terminos_detalle';      //NOMBRE DE LA TABLA EN LA BASE DE DATOS
            $grilla->MyWhere            = "activo=1 AND id_empresa=$id_empresa AND id_termino=$id_termino ";     //WHERE DE LA CONSULTA A LA TABLA ""
        ...
        //CONFIGURACION DE CAMPOS EN LA GRILLA
            ...
            // $grilla->AddRowImage('Terminos','<center><img src="img/config16.png" onerror="src=\'img/true.png\'" title="Configurar terminos" style="cursor:pointer;" ></center>',60);
        ...
        //CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
            ...
            $grilla->TituloVentana      = 'Terminos'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
            ...
            $grilla->AddBotton('Regresar','regresar',' Win_Ventana_termino_detalle.close();');
        ...
        //CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddTextField('','id_termino',150,'true','true',$id_termino);
