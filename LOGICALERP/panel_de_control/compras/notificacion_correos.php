<?php
    ...
    //CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //NOMBRE DE LA GRILLA
            $grilla->GrillaName         = 'NotificacionesCartera';      //NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
        //QUERY
            $grilla->TableName          = 'empleados';      //NOMBRE DE LA TABLA EN LA BASE DE DATOS
            $grilla->MyWhere            = "activo=1 AND (username IS NOT NULL OR username!='') AND (email_empresa IS NOT NULL OR email_empresa!='') AND id_empresa=".$_SESSION['EMPRESA']." AND id_sucursal=".$filtro_sucursal;
            $grilla->OrderBy            = 'id_empresa ASC';           //LIMITE DE LA CONSULTA
        ...
        //TOOLBAR Y CAMPO DE BUSQUEDA
            ...
            $grilla->CamposBusqueda     = 'nombre,empresa,sucursal,cargo';       //VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
        ...
        //CONFIGURACION DE CAMPOS EN LA GRILLA
            ...
            $grilla->AddRow('Email','email_empresa',180);
