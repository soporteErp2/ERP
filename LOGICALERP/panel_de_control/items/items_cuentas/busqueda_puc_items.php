<?php
	...
	$nombreTabla = ($type_puc == 'niif')? 'puc_niif': 'puc';
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'busquedaPucItems';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
		...
		//TAMANO DE LA GRILLA
			...
			// $grilla->QuitarAncho		= 70;				//AJUSTE EN PIXELES QUE SE LE DESCUENTAN AL ANCHO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true'
			// $grilla->QuitarAlto			= 160;				//AJUSTE EN PIXELES QUE SE LE DESCUENTAN AL ALTO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'true'
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Descripcion','descripcion',190);
			$grilla->AddRow('Sucursal','sucursal',80);

			$grilla->AddColStyle('cuenta','text-align:right; width:65px !important; margin-right:5px;');   //ALINEAR NUMEROS LA DERECHA
...
if(!isset($opcion)){  ?>
	<script>
		function Editar_busquedaPucItems(id){ <?php echo $ejecutaFuncion; ?> }
	</script>
<?php
} ?>