<?php
	...
	$nombreCampo = ($nombreTabla == 'puc')? 'cuenta': 'cuenta_colgaap';

	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'buscarCuentaPlantilla';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
...
if(!isset($opcion)){  ?>
	<script>
		function Editar_buscarCuentaPlantilla(id){
			var cuenta = document.getElementById("div_buscarCuentaPlantilla_cuenta_"+id).innerHTML;
			if(isNaN(cuenta) || cuenta < 100000){ alert("Aviso, Seleccione una Sub Cuenta o Cuenta Auxiliar"); return; }

			document.getElementById('<?php echo $idInput; ?>').value = cuenta;
			Win_Ventana_Buscar_cuenta_plantilla.close();
		}
	</script>
<?php
} ?>