<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'costo_autorizadores_requisicion';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'costo_autorizadores_requisicion';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddComboBox('Orden','orden',150,'false','true','costo_autorizadores_requisicion,orden,orden,true','activo=1 AND id_empresa='.$id_empresa.' AND id_area='.$id_area);
...
?>
	<script>
		...
		,	inputEmpleado      = document.getElementById('costo_autorizadores_requisicion_nombre_empleado')
		,	inputEmpleadoEmail = document.getElementById('costo_autorizadores_requisicion_email')
		,	inputCargo         = document.getElementById('costo_autorizadores_requisicion_cargo')
		,	orden              = document.getElementById('costo_autorizadores_requisicion_orden')
