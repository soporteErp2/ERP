<?php
	...
	$sql="SELECT cuenta,naturaleza,estado FROM deterioro_cartera_proveedores_cuentas WHERE activo=1 AND id_empresa=$id_empresa";
...
<div style="width:100%;">
	<div class="titulos_ventana">CUENTAS DETERIORO CARTERA PROVEEDORES</div>
	...
	<div class="contenedor_tablas_cuentas">
		...
		<div class="filaDivs" id="compromiso_pago_debito_CP" style="width:100px;">&nbsp;<?php echo $arrayCuentas['compromiso_pago']['debito'] ?></div>
		<div class="divIcono" style=""  onclick="ventanaBuscarCuentaCP('compromiso_pago','debito')">
		...
		<div class="filaDivs" id="compromiso_pago_credito_CP" style="width:100px;border-top:1px solid #D4D4D4;">&nbsp;<?php echo $arrayCuentas['compromiso_pago']['credito'] ?></div>
		<div class="divIcono"  style="border-top:1px solid #D4D4D4;" onclick="ventanaBuscarCuentaCP('compromiso_pago','credito')">
			<img src="img/buscar20.png" title="Buscar Cuenta">
		</div>
		...
		<div class="filaDivs" id="incobrable_debito_CP" style="width:100px;border-top: 1px solid #D4D4D4;">&nbsp;<?php echo $arrayCuentas['incobrable']['debito'] ?></div>
		<div class="divIcono" style="border-top: 1px solid #D4D4D4;"  onclick="ventanaBuscarCuentaCP('incobrable','debito')">
			<img src="img/buscar20.png" title="Buscar Cuenta">
		</div>
		...
		<div class="filaDivs" id="incobrable_credito_CP" style="width:100px;border-top:1px solid #D4D4D4;">&nbsp;<?php echo $arrayCuentas['incobrable']['credito'] ?></div>
		<div class="divIcono"  style="border-top:1px solid #D4D4D4;" onclick="ventanaBuscarCuentaCP('incobrable','credito')">
			<img src="img/buscar20.png" title="Buscar Cuenta">
		</div>
		...
		<div class="filaDivs" id="cobro_juridico_debito_CP" style="width:100px;border-top: 1px solid #D4D4D4;">&nbsp;<?php echo $arrayCuentas['cobro_juridico']['debito'] ?></div>
		<div class="divIcono" style="border-top: 1px solid #D4D4D4;"  onclick="ventanaBuscarCuentaCP('cobro_juridico','debito')">
			<img src="img/buscar20.png" title="Buscar Cuenta">
		</div>
		...
		<div class="filaDivs" id="cobro_juridico_credito_CP" style="width:100px;border-top:1px solid #D4D4D4;">&nbsp;<?php echo $arrayCuentas['cobro_juridico']['credito'] ?></div>
		<div class="divIcono"  style="border-top:1px solid #D4D4D4;" onclick="ventanaBuscarCuentaCP('cobro_juridico','credito')">
			<img src="img/buscar20.png" title="Buscar Cuenta">
		</div>
...
<script>
	...
	function ventanaBuscarCuentaCP(estado,naturaleza) {
		...
		Win_Ventana_buscar_cuenta_puc = new Ext.Window({
		    ...
		    autoLoad    :
		    {
		        ...
		        params  :
		        {
					...
					tabla_puc    : 'puc_niif',
					cargaFuncion : 'guardarCuentaCP(id,"'+estado+'","'+naturaleza+'")',
		        }
		    },
		    tbar        :
		    [
	...
	function guardarCuentaCP(id,estado,naturaleza) {
		var cuenta = document.getElementById('div_puc_niif_cuenta_'+id).innerHTML;
		MyLoading2('on');
		Ext.get('loadForm').load({
			url     : 'cuentas_deterioro_cartera_niif/bd/bd_cartera_proveedores.php',
			scripts : true,
			nocache : true,
			params  :
			{
