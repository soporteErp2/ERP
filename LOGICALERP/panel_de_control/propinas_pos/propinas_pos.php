<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			$grilla->TableName			= 'configuracion_propinas_pos';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//TOOLBAR Y CAMPO DE BUSQUEDA
			...
			$grilla->CamposBusqueda		= 'nombre,porcentaje';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Item FE','cod_item_fe',100);
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->TituloVentana		= 'Propina en pago'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
			$grilla->VBarraBotones		= 'true';			//SI HAY O NO BARRA DE BOTONES
			$grilla->VBotonNuevo		= 'true';			//SI LLEVA EL BOTON DE AGREGAR REGISTRO
			$grilla->VBotonNText		= 'Nueva<br/>Propina'; //TEXTO DEL BOTON DE NUEVO REGISTRO
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddTextField('Cod tx','cod_tx',150,'true','false');
			$grilla->AddTextField('Item FE','cod_item_fe',150,'true','false');
...
if($opcion=='Vupdate' || $opcion=='Vagregar'){ ?>
	...
	<script>
		...
		divBtnPlantilla.setAttribute("onclick","ventanaBuscarPucCuentasPropina('colgaap')");
		...
		var divBtnPlantilla = document.createElement("div");
		divBtnPlantilla.setAttribute("class","divBtnBuscarPuc");
		divBtnPlantilla.setAttribute("onclick","ventanaBuscarPucCuentasPropina('niif')");
		divBtnPlantilla.innerHTML = '<img src="img/buscar20.png" />';
		document.getElementById("DIV_cuentasPago_cuenta_niif").appendChild(divBtnPlantilla);

		var divBtnPlantilla = document.createElement("div");
		divBtnPlantilla.setAttribute("class","divBtnBuscarPuc");
		divBtnPlantilla.setAttribute("onclick","ventanaBuscarItem()");
		divBtnPlantilla.innerHTML = '<img src="img/buscar20.png" />';
		document.getElementById("DIV_cuentasPago_cod_item_fe").appendChild(divBtnPlantilla);
...
<?php }
	...
	<script>
		function ventanaBuscarPucCuentasPropina(typeCuenta){
			// var tipoDocumento = document.getElementById('configuracion_propinas_pos_tipo').value;
		...
		function ventanaBuscarItem(){
			...
			Win_VentanaItems = new Ext.Window({
	            width       : 680,
	            height      : 500,
	            id          : 'Win_VentanaItems',
	            title       : 'Cuentas Puc',
	            ...
	            autoLoad    :
	            {
	                ...
	                nocache : true,
	                params  : { 
						nombre_grilla : 'buscar_items',
						nombreTabla : 'items',
						// sql : " activo = 1 ",
						QuitarAncho : 430,
						QuitarAlto : 470,
						cargaFuncion  : `response_items(id);`
					}
	                // params  : { tipoDocumento : tipoDocumento, typeCuenta : typeCuenta }
					// sql           : sql,
	            ...
	            [
	                {
						...
						iconCls   : 'regresar',
						iconAlign : 'top',
						handler   : function(){ Win_VentanaItems.close(); }
	                }
	            ]
	        }).show();
		}

		function response_items(id){
			let codigo = document.getElementById(`div_buscar_items_codigo_${id}`).innerHTML;
			document.getElementById("cuentasPago_cod_item_fe").value = codigo;
			Win_VentanaItems.close();
		}
