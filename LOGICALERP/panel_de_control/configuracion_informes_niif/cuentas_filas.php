<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'cuentas_fila';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'informes_niif_formatos_secciones_filas_cuentas';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->TituloVentana		= 'Ventana cuentas_fila formato'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
			...
			$grilla->AddBotton('Regresar','regresar','Win_Ventana_cuentas_fila.close();');
...
?>
	<script>
		// CUENTA INICIAL
		var inputCuentaInicial      = document.getElementById('cuentas_fila_cuenta_inicial');
		var inputDescCuentaInicial      = document.getElementById('cuentas_fila_descripcion_cuenta_inicial');
		...
		divBtnCuentaInicial.setAttribute("onclick","ventanaBuscarPucCuentasPago('colgaap','cuentas_fila_id_cuenta_inicial','cuentas_fila_cuenta_inicial','cuentas_fila_descripcion_cuenta_inicial')");
		divBtnCuentaInicial.setAttribute('title','Buscar Cuenta Colgaap');
		divBtnCuentaInicial.innerHTML = '<img src="img/buscar20.png" />';
		document.getElementById("DIV_cuentas_fila_cuenta_inicial").appendChild(divBtnCuentaInicial);

		// CUENTA FINAL
		var inputCuentaFinal      = document.getElementById('cuentas_fila_cuenta_final');
		var inputDescCuentaFinal      = document.getElementById('cuentas_fila_descripcion_cuenta_final');
		...
		var divBtnCuentaInicial = document.createElement("div");
		divBtnCuentaInicial.setAttribute("class","divBtnBuscarPuc");
		divBtnCuentaInicial.setAttribute("onclick","ventanaBuscarPucCuentasPago('colgaap','cuentas_fila_id_cuenta_final','cuentas_fila_cuenta_final','cuentas_fila_descripcion_cuenta_final')");
		divBtnCuentaInicial.setAttribute('title','Buscar Cuenta Colgaap');
		divBtnCuentaInicial.innerHTML = '<img src="img/buscar20.png" />';
		document.getElementById("DIV_cuentas_fila_cuenta_final").appendChild(divBtnCuentaInicial);
