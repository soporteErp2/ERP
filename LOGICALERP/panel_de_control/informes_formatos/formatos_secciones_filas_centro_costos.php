<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'informes_formatos_secciones_filas_centro_costos';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'informes_formatos_secciones_filas_centro_costos';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Nombre','centro_costos',100);
...
if(!isset($opcion)){  ?>
	<script>
		...
		function rederizaCentroCostos(id) {
			...
			document.getElementById('informes_formatos_secciones_filas_centro_costos_codigo_centro_costos').value = codigo;
			document.getElementById('informes_formatos_secciones_filas_centro_costos_centro_costos').value        =nombre ;
			document.getElementById('informes_formatos_secciones_filas_centro_costos_id_centro_costos').value     = id;
...
?>
	<script>
		var inputCod  = document.getElementById('informes_formatos_secciones_filas_centro_costos_codigo_centro_costos')
		,	inputCcos = document.getElementById('informes_formatos_secciones_filas_centro_costos_centro_costos')
		...
		document.getElementById("DIV_informes_formatos_secciones_filas_centro_costos_codigo_centro_costos").appendChild(divBtnPlantilla);
