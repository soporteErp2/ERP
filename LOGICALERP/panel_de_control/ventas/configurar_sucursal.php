<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'resolucion_sucursales';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'ventas_facturas_configuracion_sucursales';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
...
if(!isset($opcion)){  ?>
	<script>
		...
		//function Agregar_resolucion_sucursales(){ ventana_agregar_concepto(0); }
		// function Editar_resolucion_sucursales(id){ }
		...
		// 	Ext.get('MuestraToltip_resolucion_sucursales_'+id).load({
