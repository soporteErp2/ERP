<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			$grilla->TableName			= 'ventas_facturas_configuracion';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Numero','consecutivo_resolucion',100);
			$grilla->AddRow('Fecha Inicial','fecha_resolucion',100);
			...
			$grilla->AddRowImage('Asignar Sucursales','<center><img onClick="configuracionSucursales([id],\'[consecutivo_resolucion]\')" src="../../temas/clasico/images/BotonesTabs/sucursales16.png" style="cursor:hand;" title="Configure que sucursales usaran esta resolucion" ></center>',105)	;
			$grilla->AddRow('Consecutivo','consecutivo_factura',100);
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddTextField('Numero','consecutivo_resolucion',150,'true','false');
			$grilla->AddTextField('Fecha Inicial','fecha_resolucion',150,'true','false');
   		...
   		$grilla->AddComboBox('Tipo','tipo',150,'true','false','FC:Factura Por Computador,FE:Factura Electronica,FM:Factura Manual');
			...
			$grilla->AddTextField('Consecutivo factura','consecutivo_factura',150,'true','false');
	...
	<script>
		function configuracionSucursales(id_resolucion,num_resolucion){
			...
			Win_Ventana_config_sucursales = new Ext.Window({
			    ...
			    autoLoad    :
			    {
			        url     : 'ventas/configurar_sucursal.php',
			        scripts : true,
			        nocache : true,
			        params  :
			        {
