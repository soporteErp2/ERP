<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'busquedaCostosPuc';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Descripcion','descripcion',230);
			$grilla->AddRow('Sucursal','sucursal',140);
...
if(!isset($opcion)){  ?>
	<script>
		function Editar_busquedaCostosPuc(id){
			var cuenta = document.getElementById("div_busquedaCostosPuc_cuenta_"+id).innerHTML;
			...
			Ext.Ajax.request({
			    ...
			    success :function (result, request){
			                ...
			                document.getElementById('<?php echo $idInput2; ?>').value = id;
