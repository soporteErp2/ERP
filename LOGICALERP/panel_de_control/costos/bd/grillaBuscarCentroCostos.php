...
if(!isset($opcion)){ ?>
	...
	<script>
		...
		function Editar_CentroCostos(id) {
			...
			document.getElementById('<?php echo $opc; ?>_imgEliminarCcos').setAttribute('onclick','eliminaCcosItem(<?php echo $opc; ?>)');
			document.getElementById('<?php echo $opc; ?>_imgEliminarCcos').style.backgroundImage="url('<?php echo $carpeta_img; ?>/false.png')";
			document.getElementById('<?php echo $opc; ?>_imgEliminarCcos').setAttribute('title','Eliminar Centro de Costos');
