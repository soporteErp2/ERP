...
<div style="float:left; padding:15px; width:100%">
    ...
    <div class="ContenedorGrupoPanelControl">
        ...
        <div style="width:100%; float:left">
            ...
            <div class="IconoPanelControl" onClick="AbreVentanaPanelGlobal('configuracion_actividades_crm/configuracion_actividades_crm','Configuracion Actividades CRM',970,570,0,0);">
