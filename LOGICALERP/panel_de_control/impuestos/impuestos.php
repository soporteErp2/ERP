<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	= 'impuestos_items';  //NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->VAlto		 				= 500;								//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ANCHO DE LA VENTANA -- SOLO FUNCIONA CUANDO VAutoResize = 'true'
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddComboBox('Modulo de Compras','compra',150,'true','false','Si:Si,No:No');
			$grilla->AddComboBox('Modulo de Ventas','venta',150,'true','false','Si:Si,No:No');
			$grilla->AddComboBox('Tipo Impuesto','codigo_impuesto_dian',150,'true','false','01:IVA,03:Impuesto Al Consumo,04:Contribuciones');
			$grilla->AddComboBox('Cruzar Costo A.F','cruzar_costo_activo_fijo',150,'true','false','true:Si,false:No');
			$grilla->AddSeparator('Cuentas en Compra');
			$grilla->AddTextField('Cuenta Colgaap','cuenta_compra',150,'true','false');
			$grilla->AddTextField('Cuenta Niif','cuenta_compra_niif',150,'true','false');
			$grilla->AddSeparator('Cuentas en devoluciones de compra');
			$grilla->AddTextField('Cuenta Colgaap','cuenta_compra_devolucion',150,'true','false');
			$grilla->AddTextField('Cuenta Niif','cuenta_compra_devolucion_niif',150,'true','false');
			$grilla->AddSeparator('Cuentas en venta');
			$grilla->AddTextField('Cuenta Colgaap','cuenta_venta',150,'true','false');
			$grilla->AddTextField('Cuenta Niif','cuenta_venta_niif',150,'true','false');
			$grilla->AddSeparator('Cuentas en devoluciones de venta');
			$grilla->AddTextField('Cuenta Colgaap','cuenta_venta_devolucion',150,'true','false');
			$grilla->AddTextField('Cuenta Niif','cuenta_venta_devolucion_niif',150,'true','false');
