<?php
	...
	$sql="SELECT id_concepto FROM certificado_ingreso_retenciones_empleados_conceptos WHERE activo=1 AND id_empresa=$id_empresa AND id_seccion=$id_seccion AND id_fila=$id_fila";
	$query=mysql_query($sql,$link);
	while ($row=mysql_fetch_array($query)) {
		$whereId.=' AND id<>'.$row['id_concepto'];
	}
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_empresa='$id_empresa' $whereId";		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
			$grilla->OrderBy			= '';
