<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'ventas_pos_cajas_secciones';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'ventas_pos_cajas_secciones';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
			$grilla->MyWhere			= " activo = 1 AND id_empresa = '$id_empresa' AND id_caja=$id_caja";		//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Seccion','seccion',150);
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->TituloVentana		= 'Relacion caja - seccion'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
			...
			$grilla->AddBotton('Regresar','regresar','Win_Ventana_asignarAmbiente.close()');
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			$grilla->AddComboBox("Seccion","id_seccion",180,"true",'true',"ventas_pos_secciones,id,nombre","activo=1 AND id_empresa=$id_empresa AND restaurante='Si' ");
			$grilla->AddTextField('','seccion',200,'false','hidden', '');
			$grilla->AddTextField('','id_caja',200,'false','hidden', $id_caja);
			$grilla->AddTextField('','nombre_caja',200,'false','hidden', $nombre_caja);
...
<?php
	...
	<script>
		var selectSeccion = document.getElementById('ventas_pos_cajas_secciones_id_seccion')
		selectSeccion.setAttribute("onchange","onChangeSeccion(this)");
		var onChangeSeccion = (element) => {
			document.getElementById('ventas_pos_cajas_secciones_seccion').value = element.options[element.selectedIndex].innerText;
		}
    </script>
<?php } ?>