<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'busquedaRetencionesPuc';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
...
if(!isset($opcion)){  ?>
	<script>
		function Editar_busquedaRetencionesPuc(id){
			var cuenta = document.getElementById("div_busquedaRetencionesPuc_cuenta_"+id).innerHTML;
