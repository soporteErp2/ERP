<?php
	...
	$sqlConsecutivo   = "SELECT documento, consecutivo, modulo
						...
						WHERE activo=1 AND id_empresa='$id_empresa' AND id_sucursal='$filtro_sucursal' AND modulo='nomina'
						ORDER BY modulo ASC";
...
<div style="margin:10px; height:215px; overflow:hidden;" id="contenedorConsecutivos"><?php echo $body; ?></div>
