<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'nomina_niveles_riesgos_laborales';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nomina_niveles_riesgos_laborales';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//TAMANO DE LA GRILLA
			...
			$grilla->Ancho		 		= 415;				//ANCHO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'false'
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('%','porcentaje',80);

		//CONFIGURACION FORMULARIO
			$grilla->FContenedorAncho		= 320;
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->TituloVentana		= 'Agregar Nivel de Riesgo'; //NOMBRE DE LA VENTANA DE INSER, UPDATE Y DELETE
			$grilla->VBarraBotones		= 'true';			//SI HAY O NO BARRA DE BOTONES
			$grilla->VBotonNuevo		= 'true';			//SI LLEVA EL BOTON DE AGREGAR REGISTRO
			$grilla->VBotonNText		= 'Nuevo Nivel de Riesgo'; //TEXTO DEL BOTON DE NUEVO REGISTRO
			...
			$grilla->VAlto		 		= 170;				//AJUSTE EN PIXELES QUE SE LE DECUENTAN AL ANCHO DE LA VENTANA -- SOLO FUNCIONA CUANDO VAutoResize = 'true'
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			//$grilla->AddComboBox('Puc Compra','id_cuenta_compra',150,'false','true','puc,id,cuenta,true',' id_empresa='.$id_empresa .' AND activo=1 AND cuenta like "24%" AND cuenta>99999');
			//$grilla->AddComboBox('Puc Venta','id_cuenta_venta',150,'false','true','puc,id,cuenta,true',' id_empresa='.$id_empresa .' AND activo=1 AND cuenta like "24%" AND cuenta>99999');
