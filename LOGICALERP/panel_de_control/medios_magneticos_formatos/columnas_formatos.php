<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'medios_magneticos_formatos_columnas';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'medios_magneticos_formatos_columnas';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE LOS FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddComboBox('Orden','orden',150,'true','true','medios_magneticos_formatos_columnas,orden,orden,true','activo=1 AND id_formato='.$id_formato.' ORDER BY orden ASC');
			$grilla->AddTextField('Nombre:','nombre',150,'true','false');
            $grilla->AddValidation('orden','unico_global','id_formato='.$id_formato);
...
?>
	<script>
		var orden = 0
		var select = document.getElementById("medios_magneticos_formatos_columnas_orden");
