<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'medios_magneticos_formatos';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'medios_magneticos_formatos';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//CONFIGURACION DE LA VENTANA DE INSERT, UPDATE Y DELETE
			...
			$grilla->AddBotton('Cargar Formatos <br>Basicos','Copier','cargar_formatos_basicos();');
	...
	<script>
		...
		function ventana_conceptos(id,codigo){
			...
			Win_Ventana_conceptos = new Ext.Window({
			    ...
			    autoLoad    :
			    {
			        url     : 'medios_magneticos_formatos/conceptos_formatos.php',
			        scripts : true,
			        nocache : true,
			        params  :
			        {
		...
		function ventana_columnas(id,codigo){
			...
			Win_Ventana_columnas = new Ext.Window({
			    ...
			    autoLoad    :
			    {
			        url     : 'medios_magneticos_formatos/columnas_formatos.php',
			        scripts : true,
			        nocache : true,
			        params  :
			        {
		...
		function cargar_formatos_basicos() {
			...
			Ext.Ajax.request({
			    url     : 'medios_magneticos_formatos/bd/bd.php',
			    params  :
			    {
			    ...
			    success :function (result, request){
			                ...
			                if(resul.split('{.}')[1] == 'true'){
			                	...
			                	MyBusquedamedios_magneticos_formatos();
			                }
			                else{
		                		...
		                		// document.getElementById('ContenedorPrincipal_medios_magneticos_formatos').innerHTML=resul.split('{.}')[1];
			                }
			            },
			    failure : function(){
			    	MyLoading2('off',{icono:'fail',texto:'No se cargaron los formatos<br>intentelo de nuevo',duracion:3000 });
