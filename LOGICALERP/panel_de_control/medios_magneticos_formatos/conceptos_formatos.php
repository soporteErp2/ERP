<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'medios_magneticos_formatos_conceptos';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'medios_magneticos_formatos_conceptos';		//NOMBRE DE LA TABLA EN LA BASE DE DATOS
		...
		//TOOLBAR Y CAMPO DE BUSQUEDA
			...
			$grilla->CamposBusqueda		= 'descripcion,Concepto';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
			$grilla->DivActualiBusqueda = '' ;				//VARIABLE QUE DEFINE LA CAPA DONDE SE ACTUALIZA LA GRILLA DESPUES DE UNA BUSQUEDA

		//CONFIGURACION DE CAMPOS EN LA GRILLA
			$grilla->AddRow('Concepto','concepto',80);
			$grilla->AddRow('Descripcion','descripcion',400);
			$grilla->AddRowImage('Cuentas','<center><img src="../../temas/clasico/images/BotonesTabs/table_gear.png" style="cursor:pointer" width="16" height="16" title="Cuentas del Formato" onclick="ventana_cuentas(\'[id]\',\'[concepto]\')"></center>',56);
		...
		//CONFIGURACION DE LOS FORMULARIOS DE CAPTURA Y EDICION
			$grilla->AddSeparator('Informacion del concepto');
			$grilla->AddTextField('Concepto:','concepto',150,'true','false');
...
if(!isset($opcion)){  ?>
	<script>
		...
		function ventana_cuentas(id,concepto){

			Win_Ventana_conceptos_cuentas = new Ext.Window({
			    width       : 650,
			    height      : 600,
			    id          : 'Win_Ventana_conceptos_cuentas',
			    title       : 'cuentas del concepto '+concepto+' del formato <?php echo $codigo ?>',
			    modal       : true,
			    autoScroll  : false,
			    closable    : false,
			    autoDestroy : true,
			    autoLoad    :
			    {
			        url     : 'medios_magneticos_formatos/conceptos_cuentas_formatos.php',
			        scripts : true,
			        nocache : true,
			        params  :
			        {
						id_formato     : '<?php echo $id_formato; ?>',
						codigo_formato : '<?php echo $codigo ?>',
						id_concepto    : id,
						concepto       : concepto,
			        }
			    }
...
?>
	<script>
		// var orden = 0
		// var select = document.getElementById("medios_magneticos_formatos_conceptos_orden");
