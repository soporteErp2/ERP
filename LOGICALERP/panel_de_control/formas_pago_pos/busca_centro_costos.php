...
if(!isset($opcion)){  ?>
	<script>
		...
		function Editar_centroCostos(id){
			...
			document.getElementById('cuentasPago_id_centro_costos').value  = id;
			document.getElementById('cuentasPago_cod_centro_costos').value = codigo_centro_costos;
			document.getElementById('cuentasPago_centro_costos').value     = centro_costos;
