<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'busquedaPucCuentaPago';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
...
if(!isset($opcion)){  ?>
	<script>
		function Editar_busquedaPucCuentaPago(id){
			var id_input = ''
			,	cuenta   = document.getElementById("div_busquedaPucCuentaPago_cuenta_"+id).innerHTML;

			if('<?php echo $typeCuenta; ?>' == 'niif'){ id_input = '_niif'; }
			...
			Ext.Ajax.request({
	            ...
	            success :function (result, request){
                        	...
                        	// document.getElementById("cuentasPago_cuenta"+id_input).value = cuenta;
                        	document.getElementById('<?php echo $id_input; ?>').value = cuenta;
