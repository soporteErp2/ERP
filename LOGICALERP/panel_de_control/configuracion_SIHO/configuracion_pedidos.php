...
<div style="width:100%;">
	<div class="titulos_ventana">VALOR ITEMS EN PEDIDOS</div>
	...
	<div class="contenedor_tablas_cuentas">
		...
		<div class="filaDivs" style="width:calc(100% - 3px);text-align:center;" id="tercero">
			<select onchange="guardaTipoValorPedido(this.value)" id='tipo_valor'>
...
<script>
	<?php echo $script; ?>
	function guardaTipoValorPedido(tipo) {
