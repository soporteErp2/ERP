<?php
    ...
    */
    class ReportNiif extends ClassReport
    {
        ...
        public $IMPRIME_XLS = false;
        public $IMPRIME_PDF = false;
        ...
        */
        function __construct($id_formato,$fecha_inicio,$fecha_final,$separador_miles,$separador_decimales,$arrayCentroCostosJSON,$id_sucursal,$id_empresa,$mysql,$IMPRIME_XLS,$IMPRIME_PDF)
        {
            // parent::__construct();

            // INICIALIZAR EL CONSTRUCTOR DE LA CLASE PADRE
            parent::__construct($id_formato,$fecha_inicio,$fecha_final,$separador_miles,$separador_decimales,$arrayCentroCostosJSON,$id_sucursal,$id_empresa,$mysql);
        ...
        public function showFormat()
        {
            if ($this->IMPRIME_XLS=='true') {
                ...
                $this->getHtmlPdf($this->IMPRIME_PDF);
            }
        }
    ...
    $object = new ReportNiif($id_formato,$MyInformeFiltroFechaInicio,$MyInformeFiltroFechaFinal,$separador_miles,$separador_decimales,$arrayCentroCostosJSON,$sucursal,$id_empresa,$mysql,$IMPRIME_XLS,$IMPRIME_PDF);
    $object->showFormat();
?>