...
<script>
    ...
    document.getElementById("cuenta_inicial").value=(typeof(localStorage.cuenta_inicialLANIIF )!="undefined")? localStorage.cuenta_inicialLANIIF  : "" ;
    document.getElementById("cuenta_final").value=(typeof(localStorage.cuenta_finalLANIIF )!="undefined")? localStorage.cuenta_finalLANIIF  : "" ;

    if (typeof(localStorage.sucursal_libro_auxiliarNIIF)!="undefined")
        if (localStorage.sucursal_libro_auxiliarNIIF!="")
            setTimeout(function(){document.getElementById("filtro_sucursal_sucursales_libro_auxiliar").value=localStorage.sucursal_libro_auxiliarNIIF;},100);

    if (typeof(localStorage.MyInformeFiltroFechaInicioLibroAuxiliarNIIF)!="undefined")
        if (localStorage.MyInformeFiltroFechaInicioLibroAuxiliarNIIF!="")
            document.getElementById("MyInformeFiltroFechaInicio").value=localStorage.MyInformeFiltroFechaInicioLibroAuxiliarNIIF;

    if (typeof(localStorage.MyInformeFiltroFechaFinalLibroAuxiliarNIIF)!="undefined")
        if (localStorage.MyInformeFiltroFechaFinalLibroAuxiliarNIIF!="")
            document.getElementById("MyInformeFiltroFechaFinal").value=localStorage.MyInformeFiltroFechaFinalLibroAuxiliarNIIF;

    if (typeof(localStorage.totalizado_libro_auxiliarNIIF)!="undefined")
        if (localStorage.totalizado_libro_auxiliarNIIF!="")
            document.getElementById("totalizado").value=localStorage.totalizado_libro_auxiliarNIIF;

    if (typeof(localStorage.order_libro_auxiliarNIIF)!="undefined")
        if (localStorage.order_libro_auxiliarNIIF!="")
            document.getElementById("order").value=localStorage.order_libro_auxiliarNIIF;

    if (typeof(localStorage.by_libro_auxiliarNIIF)!="undefined")
        if (localStorage.by_libro_auxiliarNIIF!="")
            document.getElementById("by").value=localStorage.by_libro_auxiliarNIIF;
    ...
    tercerosConfiguradosLANIIF.forEach(function(elemento) {rows += elemento;});
    ...
    centroCostosConfiguradosLANIIF.forEach(function(elemento) {rows += elemento;});
