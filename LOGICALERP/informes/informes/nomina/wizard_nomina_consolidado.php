    ...
    <div class="sub-content" data-position="right">
        ...
        <div class="content-grilla-filtro">
            <div class="head">
                ...
                <div class="cell" data-col="1" data-icon="search" title="Buscar Clientes" onclick="ventanaBusquedaGrillas('empleados');"></div>
            </div>
...
<script>
    ...
    if (typeof(localStorage.MyInformeFiltroFechaInicioNominaConsolidado)!="undefined")
        if (localStorage.MyInformeFiltroFechaInicioNominaConsolidado!="")
            document.getElementById("MyInformeFiltroFechaInicio").value=localStorage.MyInformeFiltroFechaInicioNominaConsolidado;

    if (typeof(localStorage.MyInformeFiltroFechaFinalNominaConsolidado)!="undefined")
        if (localStorage.MyInformeFiltroFechaFinalNominaConsolidado!="")
            document.getElementById("MyInformeFiltroFechaFinal").value=localStorage.MyInformeFiltroFechaFinalNominaConsolidado;
    ...
    // // RECORRER EL ARRAY PARA RENDERIZAR LOS EMPLEADOS DEL FILTRO
    arrayEmpleadosConsolidadoNomina.forEach(function(elemento) {rows += elemento;});
