<?php
	...
	$informe->InformeTitle          =	'Informes Logicalsoft-ERP'; //TITULO DEL INFORME
...
<script>
	...
	function ventanaConfigurarInforme(){
		Win_Ventana_configurar_report = new Ext.Window({
		    ...
		    autoLoad    :
		    {
		        url     : '../informes/informes/report/wizard_report.php',
		        scripts : true,
		        nocache : true,
		        params  :
		        {
	...
	function generarHtml(){
        ...
        localStorage.separador_miles                = separador_miles;
        localStorage.separador_decimales            = separador_decimales;
        localStorage.MyInformeFiltroFechaInicioERPR = MyInformeFiltroFechaInicio;
        localStorage.MyInformeFiltroFechaFinalERPR = MyInformeFiltroFechaFinal;
	...
	function generarPDF_Excel(tipo_documento){
        ...
        window.open("../informes/informes/report/report_Result.php?"+data);
