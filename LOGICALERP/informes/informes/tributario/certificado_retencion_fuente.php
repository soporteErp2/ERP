<?php
	...
	$informe->InformeTitle          = 'Certificado de Retencion en la Fuente'; //TITULO DEL INFORME
...
<script>
	...
	function ventanaConfigurarInforme(){
		Win_Ventana_configurar_medios_magneticos = new Ext.Window({
		    ...
		    autoLoad    :
		    {
		        url     : '../informes/informes/tributario/wizard_certificado_retencion_fuente.php',
		        scripts : true,
		        nocache : true,
		        params  :
		        {
	...
	function generarHtml(){
		...
		Ext.get('RecibidorInforme_certificado_ingresos_retenciones').load({
			url     : '../informes/informes/tributario/certificado_retencion_fuente_Result.php',
		...
		localStorage.fecha_inicio_CRFTE      = fecha_inicio;
		localStorage.fecha_final_CRFTE       = fecha_final;
		localStorage.id_tercero_CRFTE        = id_tercero;
		localStorage.documento_tercero_CRFTE = documento_tercero;
		localStorage.nombre_tercero_CRFTE    = nombre_tercero;
	...
	function generar_Excel(){
		...
		window.open("../informes/informes/tributario/certificado_retencion_fuente_Result.php?IMPRIME_PDF=true"+bodyVar);
