<?php
    ...
    $object = new CRFTE($fecha_inicio,$fecha_final,$id_tercero,$id_empresa,$mysql,$IMPRIME_PDF);
    $object->createCert();


    /**
    * @class CRFTE Certificado de Retencion ICA
    */
    class CRFTE
    {
        private $mysql            = '';
        ...
        */
        ...
        {
            $sql="SELECT id,retencion,valor,cuenta,ciudad,base
                    FROM retenciones
                    WHERE
                        activo=1
                    AND id_empresa=$this->id_empresa
                    AND tipo_retencion='ReteFuente'
                    AND modulo='compra'";
            $query=$this->mysql->query($sql,$this->mysql->link);
        ...
        */
        public function createCert()
        {
            ...
            // Ciudad donde se practic� la retenci�n:
            // Ciudad donde se consign� la retenci�n:
            $formato.='
                        <style>
                        ...
                        <div class="head">
                            <table align="center" class="tableHead">
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr><td style="width:100%; font-weight:bold; font-size:14px; text-align:center;text-transform: uppercase;">Certificado de Retencion en la Fuente</td></tr>
                        ...
                        <div class="body">
                            <table class="tableResponsable">
                                ...
                                <tr><td><b>Nit: </b></td><td> '.$this->arrayInfotercero['numero_identificacion'].'</td></tr>
                                <tr><td><b>Direccion: </b></td><td>'.$this->arrayInfotercero['direccion'].'</td></tr>
                                <tr><td><b>Ciudad: </b></td><td>'.$this->arrayInfotercero['ciudad'].'</td></tr>
                                <tr><td><b>Ciudad retencion: </b></td><td>'.$this->arrayInfoEmpresa['ciudad'].'</td></tr>
                                <tr><td><b>Ciudad consignacion: </b></td><td>'.$this->arrayInfoEmpresa['ciudad'].'</td></tr>
                            </table>
