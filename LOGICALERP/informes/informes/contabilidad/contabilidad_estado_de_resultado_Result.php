<?php
    ...
    if (!isset($MyInformeFiltroFechaFinal) || $MyInformeFiltroFechaFinal=='') {
        ...
        if ($nivel_cuentas=='Grupos'){ $varCortar=2; }
        else if ($nivel_cuentas=='Cuentas'){ $varCortar = 4; }
        else if ($nivel_cuentas=='Subcuentas'){ $varCortar = 6; }
...
<?php
	...
	if($IMPRIME_PDF == 'true'){
        ...
        $fecha = date("Y-m-d");
        $documento = "Estado_resultado_".$fecha;
