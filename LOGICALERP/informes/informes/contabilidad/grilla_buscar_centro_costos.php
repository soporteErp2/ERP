<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//TOOLBAR Y CAMPO DE BUSQUEDA Y FILTROS
			...
			$grilla->CamposBusqueda		= 'codigo,nombre';
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Nombre','nombre',170);
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			...
			var nombre = document.getElementById('div_<?php echo $opcGrillaContable; ?>_nombre_'+id).innerHTML;
			<?php echo $funcion; ?>
		}
