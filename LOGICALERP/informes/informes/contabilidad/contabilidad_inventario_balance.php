...
<script>
	...
	if(id_pais != 49){
		url_variable = '../informes/informes/contabilidad/contabilidad_inventario_balance_paises_Result.php';
	}
	else{
		url_variable = '../informes/informes/contabilidad/contabilidad_inventario_balance_Result.php';
	}
