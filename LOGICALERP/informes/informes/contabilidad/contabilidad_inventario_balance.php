...
<script>
	...
	function ventanaConfigurarInforme(){
		...
		Win_Ventana_configurar_balance_general = new Ext.Window({
		    ...
		    autoLoad    :
		    {
		        url     : '../informes/informes/contabilidad/wizard_libro_inventario_balance.php',
		        scripts : true,
		        nocache : true,
	...
	function generarHtml(){
		...
		var rango   = document.getElementById('rango_balance').value;
	...
	function generarPDF_Excel(tipo_documento){
		...
		if (tipo_balance=='clasificado') { MyInformeFiltroFechaInicio=''; }
		else if (tipo_balance=='comparativo') { MyInformeFiltroFechaInicio=document.getElementById('MyInformeFiltroFechaInicio').value; }
		else{ return; }
