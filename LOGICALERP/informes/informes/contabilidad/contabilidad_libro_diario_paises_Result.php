<?php
  ...
  if(!isset($MyInformeFiltroFechaInicio) && !isset($MyInformeFiltroFechaFinal)){
    ...
    $script =  'localStorage.MyInformeFiltroFechaFinalLibroDiario  = "";
  ...
  while($row = mysql_fetch_array($queryAsientos)){
    ...
    $bodyTable .=  '<tr class="fila">
                      ...
                      <td style="'.$style.'" colspan="2" >'.$row['consecutivo_documento'].'</td>
...
<body>
  ...
  <div class="my_informe_Contenedor_Titulo_informe">
    <table class="table">
      <thead>
        <tr>
          <td width=""><b>CUENTA</b></td>
          <td width=""><b>COMPROBANTE</b></td>
          <td width=""><b>CONSECUTIVO</b></td>
          <td width=""><b>FECHA</b></td>
          <td width=""><b>DEBITO</b></td>
          <td width=""><b>CREDITO</b></td>
        </tr>
      </thead>
      <?php echo $bodyTable; ?>
    </table>
