<?php
    ...
    if($IMPRIME_XLS=='true'){
       ...
       header("Content-Disposition: attachment; filename=informe_cotizaciones_".date("Y_m_d").".xls");
    ...
    $sql="SELECT
                ...
                FROM
                    ventas_cotizaciones AS TP,
                    ventas_cotizaciones_inventario AS TI
                WHERE
                    TP.activo = 1
                AND TP.id_empresa = $id_empresa
                AND TP.estado = 1
                AND TI.id_cotizacion_venta=TP.id
    ...
    while ($row=mysql_fetch_array($query)) {
        ...
        $bodyTable.='<tr>
                        ...
                        <td style="'.$style.'text-align:right;padding-right:8px;" >'.validar_numero_formato(($row['subtotal']+$row['iva']),$IMPRIME_XLS).'</td>
                    </tr>';
        ...
        <div style="float:left; width:100%">
            <div style="float:left;width:100%; text-align:center;margin-bottom:15px;">
                <table align="center" style="text-align:center;" >
                    ...
                    <tr><td style="font-size:13px;"><b>Informe Cotizaciones</b><br> <?php echo $subtitulo_cabecera; ?><br>&nbsp;</td></tr>
                ...
                <table class="table" >
                    <thead>
                        <tr>
                            ...
                            <td style="width:80px;text-align:center;"><b>CONSECUTIVO</b></td>
                            ...
                            <td style="width:80px;text-align:right;padding-right:8px;"><b>TOTAL</b></td>

                        </tr>
                    </thead>
                    <?php echo $bodyTable; ?>
                    <tr style="font-weight:bold;" class="total">
                        <td style="text-align:center;" colspan="4">TOTAL COTIZACIONES</td>
                        ...
                        <td style="text-align:right;padding-right:8px;" > <?php echo validar_numero_formato($acumuladoTotal,$IMPRIME_XLS); ?></td>
                    </tr>
                </table>
            </div>
        </div>
