...
<script>
    ...
    function carga_sucursal_guardada(){
      try{
        if(typeof(localStorage.sucursal_archivos_adjuntos) != "undefined" && localStorage.sucursal_archivos_adjuntos != ""){
          setTimeout(function(){
            document.getElementById("filtro_sucursal_sucursales_archivos_adjuntos").value = localStorage.sucursal_archivos_adjuntos;
          },1000);
        }
      } catch{
