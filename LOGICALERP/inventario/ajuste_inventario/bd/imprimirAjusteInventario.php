<?php
    ...
    while ($array= mysql_fetch_array($queryArticulos)) {
        ...
        $bodyTable.='<tr>
                        ...
                        <td style="'.$estilo.' text-align:right;">'.$cantidad_salida.'</td>
...
<body >
    <div style="float:left; width:100%">
        ...
        <div style="float:left;width:50%;">
            <table style="font-size: 12px;">
                ...
                <tr>
                    <td>Remision de Venta Cruce:</td>
                    <td><b><?php echo $consecutivo_remision_venta ?></b></td>
                </tr>
                <tr>
                    <td>Entrada de Almacen Cruce:</td>
                    <td><b><?php echo $consecutivo_entrada_almacen ?></b></td>
                </tr>
            </table>
        </div>
    ...
    <div class="my_informe_Contenedor_Titulo_informe">
        ...
        <table class="articlesTable">
            <thead>
                <tr>
                    ...
                    <td style="text-align:right;">CANT. SALIDA</td>
        ...
        <table align="right" style="width:25%; font-style:normal; font-size:11px; margin:20px 0px 0px 0px; border-collapse:collapse;" >
            <tr>
                <td style="width:50px; ">Subtotal Ingresos</td>
                <td style="width:10px;">$</td>
                <td style="width:50px;text-align:right;"><?php echo number_format($totalIngresos,$_SESSION['DECIMALESMONEDA']); ?></td>
            </tr>
            <tr>
                <td style="width:50px; ">Subtotal Salidas</td>
                <td style="width:10px;">$</td>
                <td style="width:50px;text-align:right; border-bottom:1px solid;"><?php echo number_format($totalSalidas,$_SESSION['DECIMALESMONEDA']); ?></td>
            </tr>
            <tr >
