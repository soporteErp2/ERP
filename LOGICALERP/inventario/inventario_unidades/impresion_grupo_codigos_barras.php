<?php
	...
	echo'<div style="margin:20px 5px 5px 5px">
			<div>
	...
	echo'<script>
			function cargar_opcion_a(){ document.getElementById("opcion_imprimir_barras").value = "buscar_rango_barras"; };
			function cargar_opcion_b(){ document.getElementById("opcion_imprimir_barras").value = "buscar_fecha_barras"; };
		</script>';	
?>
