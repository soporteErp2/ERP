<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'buscarNotaContable';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
			$grilla->TableName			= 'nota_contable_general';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
			$grilla->MyWhere			= "activo = 1 AND estado=1 AND id_empresa=$empresa AND (sinc_nota='colgaap_niif' OR sinc_nota='colgaap') ";						//WHERE DE LA CONSULTA A LA TABLA "$TableName"
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_buscarNotaContable(id){

			document.getElementById('consecutivo').value      = document.getElementById('div_buscarNotaContable_consecutivo_'+id).innerHTML;
			document.getElementById('consecutivo').dataset.id = id;
	  ...
	  //           titulo=document.getElementById('div_<?php echo $opcGrillaContable; ?>_tipo_nota_'+id).innerHTML;
	  ...
	  //       Ext.get("contenedor_<?php echo $opcGrillaContable; ?>").load({
	 	...
	 	// 		if(consecutivoDoc != ''){ document.getElementById('titleDocuemento<?php echo $opcGrillaContable; ?>').innerHTML='Nota Contable<br>N. '+consecutivoDoc; }
			// 	else{ document.getElementById('titleDocuemento<?php echo $opcGrillaContable; ?>').innerHTML='' }

			Win_Ventana_bucarNotaContable.close();
		}
