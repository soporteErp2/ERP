<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_sucursal=$id_sucursal AND id_bodega=$id_bodega AND id_empresa=$id_empresa
		...
		//TOOLBAR Y CAMPO DE BUSQUEDA Y FILTROS
			...
			$grilla->CamposBusqueda		= 'fecha_registro,consecutivo,sucursal_traslado,bodega_traslado';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			...
			$grilla->AddRow('Consecutivo','consecutivo',70);
 			...
 			$grilla->AddRow('Bodega trasldo','bodega_traslado',100);
 			$grilla->AddRow('Sucursal trasldo','sucursal_traslado',100);
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			var direccionRender = 'traslados/grillaContableBloqueada.php'
			,	estado          = document.getElementById('imgEstado<?php echo $opcGrillaContable; ?>_'+id).getAttribute('src');

        	titulo='Traslado de inventario';
        	if(estado == 'img/estado_doc/0.png'){ direccionRender = 'traslados/grillaContable.php'; }
	        ...
	        Ext.get("contenedor_<?php echo $opcGrillaContable; ?>").load({
				...
				params  :
				{
					...
					filtro_bodega     : "<?php echo $id_bodega ?>",
				}
			});
