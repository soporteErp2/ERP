...
<div style="float:left; margin: 5px 0 0 10px">
    ...
    <div id="recibidor_filtro_empresa_<?php echo $opc; ?>" style="float:left; width:190px;height:23px;">
	    <select class="myfield" name="filtro_ubicacion_<?php echo $opc; ?>" id="filtro_sucursal_<?php echo $opc; ?>" style="width:190px" onChange="cambia_filtro_bodega_<?php echo $opc; ?>()">
	        <?php
