...
<div id="contentAnularComandas" style="width:100%;height:calc(100% - 100px);"></div>
...
<script>
				...
				[
					{
						...
						text  : `<div style="width:100%; float:left;">
									<div style="width:100%; float:left;">
										<div style="float:left; width:80px; padding-top:2px;">Ambiente</div>
										<div style="float:left; width:160px; padding-top:0px;">
											<select id="selectAmbiente" style="width:100%;">
					...
					},"--","->",
					{
						...
						text  : `<div style="width:100%; float:left;">
								...
								<div style="width:100%; float:left;">
									...
									<div style="/*width:80px;*/ float:left; font-size:12px; color:#ffffff; padding:3px 0px 0px 3px;">Bloqueada (Facturara o Auditada) </div>
								</div>
								<div style="width:100%; float:left;">
	...
	var loadGrilla = ()=>{
		$W.Load({
			idApply : "contentAnularComandas",
			url     : "anular_comandas/grilla.php",
			params  : {
