<?php
	...
	if($MSucursales == 'true' && $MEmpresas == 'false')	{$filtroE = 'AND id = '.$_SESSION['EMPRESA'];}
	if($MSucursales == 'false' && $MEmpresas == 'false'){$filtroE = 'AND id = '.$_SESSION['EMPRESA'];}
	...
	$consulE = mysql_query("SELECT id,nombre FROM empresas WHERE activo=1 $filtroE",$link);

?>
<div style="float:left; margin: 5px 0 0 10px;display:none">
...
<div style="float:left; margin: 15px 0 0 10px">
    ...
    <div id="recibidor_filtro_empresa" style="float:left; width:150px">
