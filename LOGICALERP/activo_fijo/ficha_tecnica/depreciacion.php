<?php
	...
	while($row = $mysql->fetch_array($query)){
		$bodyTable .=  "<tr>
											...
											<td>".round($row['depreciacion_acumulada'],$_SESSION['DECIMALESMONEDA'])."</td>
...
<div class="content-personal-info">
	<div class="separator-body" >DEPRECIACION COLGAAP</div>
	<table class="table-form">
		...
		<tr>
			...
			<td><input type="text" readonly="readonly" value="<?php echo round($depreciacion_acumulada,$_SESSION['DECIMALESMONEDA']); ?>"></td>
		</tr>
		<tr>
			<td>Valor actual</td>
			<td><input type="text" readonly="readonly" value="<?php echo round($costo - $depreciacion_acumulada,$_SESSION['DECIMALESMONEDA']); ?>"></td>
		</tr>
	</table>
