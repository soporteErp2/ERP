<?php
	...
	switch ($opc) {
		...
		case 'guardar_datos_personales':
			guardar_datos_personales($id_empleado,$pais_documento,$departamento_documento,$ciudad_documento,$fecha_nacimiento,$pais_nacimiento,$departamento_nacimiento,$ciudad_nacimiento,$sexo,$pais_residencia,$departamento_residencia,$ciudad_residencia,$direccion,$barrio,$telefono,$telefono_alterno,$numero_celular,$email,$email_empresa,$grupo_sanguineo,$rh,$alergico,$medicamentos,$id_empresa,$mysql);
			break;
	...
	function guardar_datos_personales($id_empleado,$pais_documento,$departamento_documento,$ciudad_documento,$fecha_nacimiento,$pais_nacimiento,$departamento_nacimiento,$ciudad_nacimiento,$sexo,$pais_residencia,$departamento_residencia,$ciudad_residencia,$direccion,$barrio,$telefono,$telefono_alterno,$numero_celular,$email,$email_empresa,$grupo_sanguineo,$rh,$alergico,$medicamentos,$id_empresa,$mysql){
		if (!filter_var($email, FILTER_VALIDATE_EMAIL) || !filter_var($email_empresa, FILTER_VALIDATE_EMAIL)) {
		    echo "<script>MyLoading2('off',{icono:'fail', texto:'Email no valido' } );</script>";
		    exit;
		}
