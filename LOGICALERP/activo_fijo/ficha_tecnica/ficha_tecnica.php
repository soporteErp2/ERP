...
?>
<link rel="stylesheet" type="text/css" href="ficha_tecnica/index.css">
<div class="content">
	<div class="separator">FICHA TECNICA ACTIVO FIJO <div class="close" onclick="Win_Ventana_ficha_tecnica.close();"></div></div>
	...
	<div class="content-tab">
		<div id="tab1" onclick="tab_event('panel1', this);">INFO. BASICA</div>
		<div id="tab2" onclick="tab_event('panel2', this);">DEPRECIACION</div>
		<!-- <div id="tab3" onclick="tab_event('panel3', this);">DEPRECIACION NIIF</div> -->
		<!-- <div id="tab4" onclick="tab_event('panel4', this);">EXPERIENCIA LABORAL</div> -->
	</div>
	<div class="content-tab-content">
		<div id="panel1" class="tab-content"><?php include 'informacion_basica/informacion_basica.php'; ?></div>
		<div id="panel2" class="tab-content"><?php include 'depreciacion/depreciacion.php'; ?></div>
