...
<?php
    ...
    if(!isset($id_deterioro)){
        ...
        $id_deterioro = mysql_result(mysql_query($sqlSelectId,$link),0,'id');
        ...
        // cargarActivosFijosSucursal($id_deterioro,$tablaPrincipal,$tablaInventario,$idTablaPrincipal,$id_empresa,$id_sucursal,$link);
    ...
    //============================== SI EXISTE LA DOCUMENTO ===============================//
        ...
        if ($consecutivo>0) {
            $acumScript.='document.getElementById("titleDocumento'.$opcGrillaContable.'").innerHTML = "Consecutivo N.<br>'.$consecutivo.'";';
        }
        else{
...
<script>
        ...
        Win_Ventana_buscar_Articulo_factura = new Ext.Window({
            ...
            autoLoad    :
            {
                ...
                params  :
                {
                    ...
                    id_deterioro : '<?php echo $id_deterioro; ?>',
                    option          : 'deterioro',
                }
            },
            tbar        :
    ...
    function guardarNewArticulo<?php echo $opcGrillaContable; ?>(cont){
        ...
        else if(valorActual < 1 || valorActual == ''){ document.getElementById('valorActual<?php echo $opcGrillaContable; ?>_'+cont).focus(); return; }
    ...
    function cargarActivosFijosSucursal() {
        Ext.get('renderizaNewArticulo<?php echo $opcGrillaContable; ?>').load({
            ...
            params  :
            {
                ...
                id_documento : '<?php echo $id_deterioro ?>',
                opcGrillaContable : '<?php echo $opcGrillaContable; ?>'
            }
        });
    }
    ...
    function validarNumberArticulo<?php echo $opcGrillaContable; ?>(event,input,typeValidate,cont){
        ...
        if(tecla == 13){
            // if (nombreInput=='cantArticuloDepreciaciones') { document.getElementById('costoTotalArticuloDeterioro_'+contIdInput).focus(); return;}
