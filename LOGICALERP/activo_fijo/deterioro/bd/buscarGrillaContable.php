<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1  AND id_sucursal=$id_sucursal AND id_empresa=$id_empresa
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			var direccionRender = 'deterioro/bd/grillaContableBloqueada.php'
			...
			// if ('<?php echo $opcGrillaContable; ?>'=='CotizacionVenta') {
	            titulo='Depreciacion';
	            if(estado == 'images/estado_doc/0.png'){ direccionRender = 'deterioro/grilla/grillaContable.php'; }
	        // }
