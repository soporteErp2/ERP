<?php
	...
	function cargarActivosFijosSucursal($id_documento,$tablaPrincipal,$tablaInventario,$idTablaPrincipal,$id_empresa,$id_sucursal,$link){
		...
		while ($row=mysql_fetch_array($query)) {
			...
			$costo                       = $row['costo'];
			$depreciacion_acumulada      = $row['deterioro_acumulado'];
				...
				<div class="contenedorGrilla">
					...
					<div class="contenedorHeadArticulos">
						<div class="headArticulos" id="head'.$opcGrillaContable.'">
							...
							<div class="label" title="Depreciacion Acumulada">Det. Acum.</div>
							<div class="label">Costo</div>
							<div class="label">Valor Actual</div>
							<div class="label">Deterioro</div>
	...
	function cargaDivsUnidadesSave($cont,$opcGrillaContable,$id = 0,$id_activo_fijo= '',$codigo = '',$nombre = '', $unidad='', $dias_depreciar = '1',$costo = 0,$depreciacion_acumulada=0,$valor=0, $estado=''){
		...
		$body= '<div class="campo" style="width:40px !important;">
				...
				<div class="campo"><input type="text" id="deterioroAcumulada'.$opcGrillaContable.'_'.$cont.'" style="text-align:left;" readonly '.$deshabiltar.'value="'.$depreciacion_acumulada.'" /></div>
				<div class="campo"><input type="text" id="costoArticulo'.$opcGrillaContable.'_'.$cont.'" readonly value="'.$costo.'" '.$deshabiltar.' onKeyup="validarNumberArticulo'.$opcGrillaContable.'(event,this,\'double\',\''.$cont.'\');"/></div>

				<div class="campo"><input type="text" id="valorActual'.$opcGrillaContable.'_'.$cont.'" '.$deshabiltar.'  value="'.$valor.'" onKeyup="validarNumberArticulo'.$opcGrillaContable.'(event,this,\'double\',\''.$cont.'\');"/></div>
				<div class="campo"><input type="text" id="valorDeterioro'.$opcGrillaContable.'_'.$cont.'" '.$deshabiltar.' '.$readonly_precio.' value="'.((($costo-$valor)<0)? 0 : $costo-$valor).'" readonly  value="0"/></div>
				...
				<div style="float:right; min-width:80px;">
					...
					<div onclick="ventanaDescripcionArticulo'.$opcGrillaContable.'('.$cont.')" id="descripcionArticulo'.$opcGrillaContable.'_'.$cont.'" title="Configurar Item" style="width:20px; float:left; margin-top:3px; display:none;cursor:pointer;'.$mostrarImagen.'"><img src="images/config16.png"/></div>
				...
				<script>
					...
					calculaValorTotalesDocumento("agregar",'.((($costo-$valor)<0)? 0 : $costo-$valor).');
				</script>';
	...
	function cargaDivsUnidadesBloqueadas($cont,$opcGrillaContable,$id = 0,$id_activo_fijo= '',$codigo = '',$nombre = '', $unidad='', $dias_depreciar = '1',$costo = 0,$depreciacion_acumulada=0,$valor=0){
		...
		$body ='<div class="campo" style="width:40px !important;">
				...
				<div class="campo"><input type="text" id="deterioroAcumulada'.$opcGrillaContable.'_'.$cont.'" style="text-align:left;" readonly value="'.$depreciacion_acumulada.'" /></div>
				<div class="campo"><input type="text" id="costoArticulo'.$opcGrillaContable.'_'.$cont.'" value="'.$costo.'" readonly /></div>

				<div class="campo"><input type="text" id="valorActual'.$opcGrillaContable.'_'.$cont.'" '.$readonly_precio.' value="'.$valor.'" readonly value="0"/></div>
				<div class="campo"><input type="text" id="deterioro'.$opcGrillaContable.'_'.$cont.'"   readonly  value="'.((($costo-$valor)<0)? 0 : $costo-$valor).'" /></div>
