...
<?php
  $acumScript .= (user_permisos(227,'false') == 'true')? 'Ext.getCmp("Btn_guardar_'.$opcGrillaContable.'").enable();' : '';        //Guardar
  $acumScript .= (user_permisos(228,'false') == 'true')? 'Ext.getCmp("Btn_editar_'.$opcGrillaContable.'").enable();' : 'Ext.getCmp("Btn_editar_'.$opcGrillaContable.'").disable();';       //Editar
  $acumScript .= (user_permisos(229,'false') == 'true')? 'Ext.getCmp("Btn_cancelar_'.$opcGrillaContable.'").enable();' : 'Ext.getCmp("Btn_cancelar_'.$opcGrillaContable.'").disable();';   //Cancelar
  $acumScript .= (user_permisos(230,'false') == 'true')? 'Ext.getCmp("Btn_restaurar_'.$opcGrillaContable.'").enable();' : 'Ext.getCmp("Btn_restaurar_'.$opcGrillaContable.'").disable();'; //Restaurar
  ...
  $sucursal_destino              = mysql_result($query,0,'sucursal_destino');
  $bodega_destino                = mysql_result($query,0,'bodega_destino');
  ...
  $acumScript .= 'document.getElementById("titleDocumento'.$opcGrillaContable.'").innerHTML = "Traslado<br>No. '.$consecutivo.'";';
?>
<style type="text/css">
  .contenedorGrilla{
    margin-top  : 0;
    ...
    <div class="contInfoFact">
      ...
      <div class="contTopFila">
        ...
        <div class="renglonTop" id="divIdentificacionTercero">
          ...
          <div class="campoTop" style="width:230px">
            <input type="text" id="sucursal_destino<?php echo $opcGrillaContable; ?>" value="<?php echo $sucursal_destino; ?>" Readonly/>
          </div>
        </div>
        <div class="renglonTop" id="divIdentificacionTercero">
          <div class="labelTop">Bodega Destino</div>
          <div class="campoTop" style="width:230px">
            <input type="text" id="bodega_destino<?php echo $opcGrillaContable; ?>" value="<?php echo $bodega_destino; ?>" Readonly/>
          </div>
        </div>
        <div class="renglonTop">
...
<script>
  ...
  function imprimir<?php echo $opcGrillaContable; ?> (){
    window.open("traslados/bd/imprimirGrillaContable.php?id=<?php echo $id_traslado; ?>&opcGrillaContable=<?php echo $opcGrillaContable; ?>&tablaPrincipal=<?php echo $tablaPrincipal; ?>&idTablaPrincipal=<?php echo $idTablaPrincipal; ?>&tablaInventario=<?php echo $tablaInventario; ?>");
  }
