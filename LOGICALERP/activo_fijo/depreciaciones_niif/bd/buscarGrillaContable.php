<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1  AND id_sucursal=$id_sucursal AND id_empresa=$id_empresa AND sinc_nota='niif'
											AND id in(SELECT $idTablaPrincipal FROM $tablaInventario WHERE activo=1) ";						//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			$grilla->AddRowImage('Estado','<center><img src="images/estado_doc/[estado].png"  style="cursor:pointer" width="16" height="16" id="imgEstado'.$opcGrillaContable.'_[id]" /></center>','50');

			$grilla->AddRowImage('Consecutivo','<center><span id="div_Depreciaciones_consecutivo_[id]">[consecutivo_niif]</span></center>','70');
			// $grilla->AddRow('Consecutivo','consecutivo_niif',70);
			// $grilla->AddRow('Contabilidad','sinc_nota',170);
			$grilla->AddRow('Fecha','fecha_inicio',70);
			$grilla->AddRow('Documento','numero_identificacion_tercero',100);
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			var direccionRender = 'depreciaciones_niif/bd/grillaContableBloqueada.php'
			...
			// if ('<?php echo $opcGrillaContable; ?>'=='CotizacionVenta') {
	            titulo='Depreciacion';
	            if(estado == 'images/estado_doc/0.png'){ direccionRender = 'depreciaciones_niif/grilla/grillaContable.php'; }
	        // }
