...
<?php
    ...
    $sql   = "SELECT consecutivo_niif AS consecutivo,
                    fecha_inicio,
                    usuario,
                    observacion,
                    estado,
            ...
            <div class="contTopFila">
                ...
                <div class="renglonTop" id="divIdentificacionTercero">
                    ...
                    <div class="campoTop" style="width:230px">
                        <input type="text" style="width:161px"  id="nitCliente<?php echo $opcGrillaContable; ?>" value="<?php echo $numero_identificacion_tercero; ?>" Readonly/>
                    </div>
                </div>
...
//OCULTAR EL BUTTON GROUP DE CONTABILIZAR CON NIIF
    ...
    function imprimir<?php echo $opcGrillaContable; ?> (){
        window.open("depreciaciones_niif/bd/imprimirGrillaContable.php?id=<?php echo $id_depreciacion; ?>&opcGrillaContable=<?php echo $opcGrillaContable; ?>&tablaPrincipal=<?php echo $tablaPrincipal; ?>&idTablaPrincipal=<?php echo $idTablaPrincipal; ?>&tablaInventario=<?php echo $tablaInventario; ?>&tablaRetenciones=<?php echo $tablaRetenciones; ?>");
    }

    //================================== IMPRIMIR EN EXCEL ============================================//
    function imprimir<?php echo $opcGrillaContable; ?>Excel (){
       window.open("depreciaciones_niif/bd/exportarExcelGrillaContable.php?id=<?php echo $id_depreciacion; ?>&opcGrillaContable=<?php echo $opcGrillaContable; ?>&tablaPrincipal=<?php echo $tablaPrincipal; ?>&idTablaPrincipal=<?php echo $idTablaPrincipal; ?>&tablaInventario=<?php echo $tablaInventario; ?>&tablaRetenciones=<?php echo $tablaRetenciones; ?>");
    }
        ...
        if(confirm('Esta seguro de Editar el presente Documento y su contenido relacionado')){
            ...
            Ext.get("render_btns_<?php echo $opcGrillaContable; ?>").load({
                ...
                params  :
                {
                    ...
                    idDocumento       : '<?php echo $id_depreciacion; ?>',
                    opcGrillaContable : '<?php echo $opcGrillaContable; ?>',
