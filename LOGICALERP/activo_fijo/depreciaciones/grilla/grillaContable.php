...
<?php
    ...
    $acumScript .= (user_permisos(108,'false') == 'true')? 'Ext.getCmp("Btn_guardar_'.$opcGrillaContable.'").enable();Ext.getCmp("btnNueva'.$opcGrillaContable.'").enable();Ext.getCmp("Btn_buscar_'.$opcGrillaContable.'").enable();' : 'Ext.getCmp("btnNueva'.$opcGrillaContable.'").disable();Ext.getCmp("Btn_buscar_'.$opcGrillaContable.'").disable();document.getElementById("contenidoHijoDoc").style.display="none";';        //guardar
