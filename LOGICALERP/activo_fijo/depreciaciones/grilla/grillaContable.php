...
<?php
  $acumScript .= (user_permisos(108,'false') == 'true')? 'Ext.getCmp("Btn_guardar_'.$opcGrillaContable.'").enable();
                                                       ...
                                                       : 'Ext.getCmp("btnNueva'.$opcGrillaContable.'").disable();
                                                          ...
                                                          document.getElementById("contenidoHijoDepreciacion").style.display="none";';        //guardar

  $acumScript .= (user_permisos(110,'false') == 'true')? 'Ext.getCmp("Btn_cancelar_'.$opcGrillaContable.'").enable();' : '';       //cancelar
...
<div class="contenedorOrdenCompra" id="contenidoHijoDepreciacion">
  <div class="bodyTop">
...
<script>
  ...
  function responseVentanaBuscarArticulo<?php echo $opcGrillaContable; ?>(id,cont){
    ...
    ,   depreciacionAcumulada  = document.getElementById('div_buscar_activo_fijo_depreciacion_acumulada_' + id).innerHTML
    ,   nombreArticulo         = document.getElementById('div_buscar_activo_fijo_nombre_equipo_' + id).innerHTML
    ,   valorSalvamento        = document.getElementById('div_buscar_activo_fijo_valor_salvamento_' + id).innerHTML
    ...
    depreciacionAcumulada = Math.round(depreciacionAcumulada * Math.pow(10,decimales)) / Math.pow(10,decimales);
    costo                 = Math.round(costo * Math.pow(10,decimales)) / Math.pow(10,decimales);
