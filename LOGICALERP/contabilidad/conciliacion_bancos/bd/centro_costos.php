<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'centroCostos_'.$opcGrilla;  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
...
if(!isset($opcion)){  ?>
	<script>
		...
		function Agregar_centroCostos_<?php echo $opcGrilla; ?>(){ }
		function Editar_centroCostos_<?php echo $opcGrilla; ?>(id){ <?php echo $impressFunctionScript; ?> }
