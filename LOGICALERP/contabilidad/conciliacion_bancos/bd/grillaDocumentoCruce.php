...
if(!isset($opcion)){  ?>
	<script>
		...
		function Editar_<?php echo $opcGrilla; ?>(id){
			...
			if(document.getElementById('idInsertCuenta<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value > 0){
        	    document.getElementById('divImageDeshacer<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').style.display = 'block';
        	    document.getElementById("divImageSave<?php echo $opcGrilla; ?>_<?php echo $cont; ?>").style.display     = 'inline';
        	}
        	...
        	if ('<?php echo $tipo_documento_cruce; ?>'=='FC') {
				prefijo_factura = document.getElementById('div_<?php echo $opcGrilla; ?>_prefijo_factura_'+id).innerHTML
				tercero         = document.getElementById('div_<?php echo $opcGrilla; ?>_proveedor_'+id).innerHTML
        	}
        	else if ('<?php echo $tipo_documento_cruce; ?>'=='FV') {
        		prefijo_factura = document.getElementById('div_<?php echo $opcGrilla; ?>_prefijo_'+id).innerHTML
				tercero         = document.getElementById('div_<?php echo $opcGrilla; ?>_cliente_'+id).innerHTML
        	}

			document.getElementById('idDocumentoCruce<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value=id;
			document.getElementById('documentoCruce<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value='<?php echo $tipo_documento_cruce; ?>';
			document.getElementById('prefijoDocumentoCruce<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value = prefijo_factura;
			document.getElementById('numeroDocumentoCruce<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value  = document.getElementById('div_<?php echo $opcGrilla; ?>_numero_factura_'+id).innerHTML;
			document.getElementById('debito<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').focus();

			if (document.getElementById('numeroDocumentoCruce<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value != '' ) {
        		...
        		document.getElementById('imgBuscarDocumentoCruce_<?php echo $cont; ?>').setAttribute('onclick'," eliminaDocumentoCruce<?php echo $opcGrilla; ?>('<?php echo $cont; ?>')");
			}

			id_tercero=document.getElementById('id_tercero_'+id).innerHTML;

			document.getElementById('tercero<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value   = tercero;
			document.getElementById('idTercero<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').value = id_tercero;
			//CAMBIAR LOS ATRIBUTOS DE LA IMAGEN PARA QUE ELIMINE UN TERCERO
    		document.getElementById('imgBuscarTercero<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').setAttribute('src','img/eliminar.png');
    		document.getElementById('imgBuscarTercero<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').setAttribute('title','Eliminar Tercero');
    		document.getElementById('imgBuscarTercero<?php echo $opcGrilla; ?>_<?php echo $cont; ?>').setAttribute('onclick'," eliminaTercero<?php echo $opcGrilla; ?>(<?php echo $cont; ?>)");

			Win_Ventana_buscar_documento_cruce<?php echo $opcGrilla; ?>.close();
		}
