<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//TAMANO DE LA GRILLA
			...
			$grilla->Alto		 		= 510;				//ALTO DE LA GRILLA -- SOLO FUNCIONA CUANDO AutoResize = 'false'
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			// $grilla->AddRowImage('Cuenta','<div>[cuenta]</div><div style="display:none;" id="puc_id_cuenta">[id]</div>','50');
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrilla; ?>(id){ <?php echo $cargaFuncion; ?> }
	</script>
