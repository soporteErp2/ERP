<?php
	...
	function cargaArticulosSaveConTercero($id,$observacion,$estado,$opcGrillaContable,$tablaCuentasNota,$idTablaPrincipal,$link){
		...
		$sql   = "SELECT id,id_puc,cuenta_puc,descripcion_puc,debe,haber,id_tercero,tercero,tipo_documento_cruce,id_documento_cruce,prefijo_documento_cruce,numero_documento_cruce FROM $tablaCuentasNota WHERE $idTablaPrincipal='$id' ORDER BY cuenta_puc ASC";
		...
		$body = '<div class="contenedorGrilla">
			...
			// 					'.cargaDivsUnidadesSaveConTercero($cont,$opcGrillaContable, $row['id'], $row['id_puc'], $row['cuenta_puc'], $row['descripcion_puc'], $row['debe'], $row['haber'],$row['id_tercero'],$row['tercero'], $row['tipo_documento_cruce'],$row['id_documento_cruce'], $row['prefijo_documento_cruce'], $row['numero_documento_cruce']).'
			// 				</div>';
			// 	}
			// 	$cont++;
			// 	$body .='<div class="bodyDivArticulos'.$opcGrillaContable.'" id="bodyDivArticulos'.$opcGrillaContable.'_'.$cont.'">
	...
	function cargaDivsUnidadesSaveConTercero($cont,$opcGrillaContable,$id = 0,$id_puc = 0,$cuenta='',$descripcion='',$debe=0,$haber=0,$id_tercero,$tercero,$tipo_documento_cruce,$id_documento_cruce,$prefijo_documento_cruce,$numero_documento_cruce){
