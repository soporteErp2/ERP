...
<?php
    ...
    if(!isset($id_nota)){
        ...
        if(!isset($sinc_nota)) $sinc_nota = 'niif';
    ...
    //======================================================= SI EXISTE LA NOTA =================================================================
        ...
        if($sinc_nota != 'colgaap_niif' && $sinc_nota != 'niif'){ echo "ESTA NOTA NO TIENE DEFINIDA UNA FORMA DE SINCRONIZACION NIIF"; exit; }
        $acumScript .= 'var sinc_nota_'.$opcGrillaContable.' = "'.$sinc_nota.'";';
...
<script>
    ...
    function ajaxbuscarCliente<?php echo $opcGrillaContable; ?>(codCliente, inputId, typeDoc){
    ...
    function ventanaBuscarCuenta<?php echo $opcGrillaContable; ?>(cont,opc){
        ...
        if (documentoCruce>0 ) {
            sql=' AND id IN(SELECT id_cuenta AS id FROM asientos_niif WHERE id_documento='+documentoCruce+' AND tipo_documento="'+tipoDocumentoCruce+'" AND id_empresa=<?php echo $id_empresa ?> AND activo=1)';
