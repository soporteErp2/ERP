...
<?php
    ...
    if ($estado == 0) { $acumScript .= "Ext.getCmp('Btn_editar_$opcGrillaContable').enable(); Ext.getCmp('Btn_cancelar_$opcGrillaContable').enable();"; }         //documento por editar
    if ($estado == 1) { $acumScript .="Ext.getCmp('Btn_exportar_NotaGeneral').enable();Ext.getCmp('Btn_editar_$opcGrillaContable').enable(); Ext.getCmp('Btn_cancelar_$opcGrillaContable').enable();"; }         //documento generado
    else if($estado == 3){ $acumScript .= "Ext.getCmp('Btn_restaurar_$opcGrillaContable').enable();Ext.getCmp('Btn_exportar_NotaGeneral').disable();"; }      //documento cancelado
...
<script>
    ...
    function imprimir<?php echo $opcGrillaContable; ?> (cuentas){
       window.open("<?php echo $carpeta ?>bd/imprimirGrillaContable.php?id=<?php echo $id_nota; ?>&opcGrillaContable=<?php echo $opcGrillaContable; ?>&tablaPrincipal=<?php echo $tablaPrincipal; ?>&idTablaPrincipal=<?php echo $idTablaPrincipal; ?>&tablaCuentasNota=<?php echo $tablaCuentasNota; ?>&cuentas=niif");
    }
