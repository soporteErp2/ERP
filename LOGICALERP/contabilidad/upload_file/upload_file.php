<?php
    ...
    class qqFileUploader {
        ...
        function handleUpload($uploadDirectory,$typeNota,$sinc_nota,$mysql){
    ...
    $result   = $uploader->handleUpload($url,$typeNota,$sinc_nota,$mysql);
