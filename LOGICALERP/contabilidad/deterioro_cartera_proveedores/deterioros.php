<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			$grilla->TableName			= 'deterioro_cartera_proveedores';			//NOMBRE DE LA TABLA EN LA BASE DE DATOS
...
if(!isset($opcion)){ ?>
	...
	<script>
		...
		function nuevo_deterioro(id){
			...
			var	url = (estado==0)? 'deterioro_cartera_proveedores/deterioro_cartera_proveedores.php' : 'deterioro_cartera_proveedores/deterioro_cartera_proveedores_bloqueado.php' ;
