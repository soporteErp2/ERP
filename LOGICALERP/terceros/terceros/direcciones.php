<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//CONFIGURACION DE LO FORMULARIOS DE CAPTURA Y EDICION
			...
			$grilla->AddComboBox ('Departamento','id_departamento',150,'true','true','ubicacion_departamento,id,departamento,true','activo = 1 AND id_pais='.$id_pais.' ORDER BY pais ASC');
			$grilla->AddComboBox ('Ciudad','id_ciudad',150,'true','true','ubicacion_ciudad,id,ciudad,true','activo = 2');
			...
			$grilla->AddTextField('Codigo Postal','codigo_postal',150,'false','false');
			$grilla->AddTextField('# Matricula Mercantil','numero_matricula_mercantil',150,'false','false');
