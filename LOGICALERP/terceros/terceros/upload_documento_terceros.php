...
<style>
	...
	.qq-upload-button {display:block; width:100%; height:44px; background-image:url(../terceros/terceros/images_upload/boton.png)}
	.qq-upload-button-hover {/*background:#fff;*/; background-image:url(../terceros/terceros/images_upload/boton.png)}
...
<div id="fileuploader" style="background-image:url(../terceros/terceros/images_upload/fondo2.png)"></div>
...
<script>
	...
	function createUploader(){
		var uploader = new qq.FileUploader({
            ...
            action 						: '../terceros/terceros/guarda_documento_terceros.php',
            debug		  				: true,
						params	        	:	{
																	id	: '<?php echo $id; ?>',
																	td	: '<?php echo $td; ?>'
						...
						onComplete				: function(id, fileName, responseJSON){
																																			...
																																			Win_Ventana_Agregar_TercerosDocumentos.close();
									  																								},
