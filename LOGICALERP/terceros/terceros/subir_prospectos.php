<?php
        ...
        //CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            //NOMBRE DE LA GRILLA
                $grilla->GrillaName         = 'prospectos_upload';      //NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
            //QUERY
                $grilla->TableName          = 'terceros_upload';      //NOMBRE DE LA TABLA EN LA BASE DE DATOS
                $grilla->MyWhere            = "activo=1 AND id_empresa='$id_empresa' AND tercero=0";     //WHERE DE LA CONSULTA A LA TABLA ""
    ...
    if(!isset($opcion)){ ?>
        ...
        <script type="text/javascript">
            ...
            function createUploaderProspectos(){
                ...
                var uploader = new qq.FileUploader({
                    ...
                    onComplete        : function(id, fileName, responseJSON){
                                            ...
                                            if(responseJSON.idInsert > 0){ Inserta_Div_prospectos_upload(responseJSON.idInsert); }
                                        },
            ...
            createUploaderProspectos();

            function Agregar_prospectos_upload(id){ }

            function Editar_prospectos_upload(id){

                var myalto  = Ext.getBody().getHeight()
                ,   myancho = Ext.getBody().getWidth()
                ,   consecutivo = document.getElementById('div_prospectos_upload_consecutivo_'+id).innerHTML;
...

                        {
                            ...
                            autoLoad    :
                            {
                                ...
                                params  :
                                {
                                    ...
                                    urlRender     : '../terceros/terceros/subir_prospectos_registro.php',
