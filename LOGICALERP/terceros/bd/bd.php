<?php
	...
	function OptionSelectCiudad($id_departamento,$id_cliente,$clase,$link){
		...
		echo'<select class="myfieldObligatorio" name="'.$clase.'_id_ciudad" id="'.$clase.'_id_ciudad" style="width:200px" onchange="ValidarFieldVacio(this)">
				<option value="">Seleccione...</option>';
	...
	function OptionSelectDepartamentoDireccion($id_departamento,$id_cliente,$clase,$link){
		...
		if($id_departamento>=1){
			...
			echo '<select class="myfieldObligatorio" name="'.$clase.'Direcciones_id_ciudad" id="'.$clase.'Direcciones_id_ciudad" style="width:150px" onchange="ValidarFieldVacio(this)">';
