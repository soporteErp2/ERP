<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND proveedor!=''  AND id_sucursal=$id_sucursal  AND id_empresa=$id_empresa AND estado=1 AND id_saldo_inicial=0
											AND id NOT IN(SELECT id_factura_compra FROM compras_facturas_inventario WHERE activo=1)";						//WHERE DE LA CONSULTA A LA TABLA "$TableName"
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			$grilla->AddRowImage('Estado','<center><img src="img/estado_doc/[estado].png"  style="cursor:pointer" width="16" height="16" id="imgEstado'.$opcGrillaContable.'_[id]" /></center>','50');
 			...
 			$grilla->CamposBusqueda		= 'fecha_inicio,numero_factura,nit,proveedor,prefijo';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
		...
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			...
			Win_Ventana_factura_web_service = new Ext.Window({
			    ...
			    autoLoad    :
			    {
			        ...
			        {
						id_factura_venta  : id,
						opcGrillaContable : 'FacturaComra',
			        }
			    },
			    tbar        :
			    [
