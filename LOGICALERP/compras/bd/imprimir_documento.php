<?php
	...
	elseif ($opcGrillaContable=='RequisicionCompra') {
		...
		$displayTablaTotales = "display:none";
	}
	elseif ($opcGrillaContable=='OrdenCompra') {
	...
	elseif ($opcGrillaContable=='EntradaAlmacen') {
		$documento        = 'Entrada de Almacen';
	...
	// echo '<script>console.log("'.$sql_orden_compra.'")</script>';
	...
	if($IMPRIME_PDF){
		...
		if($id_empresa == 1 ||  $id_empresa == 47){
        	...
        	include("clausula_orden_compra.php");
