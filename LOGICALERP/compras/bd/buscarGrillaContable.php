<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND proveedor!='' AND id_sucursal=$id_sucursal AND id_bodega=$filtro_bodega AND id_empresa=$id_empresa
		...
		//CONFIGURACION DE CAMPOS EN LA GRILLA
			$grilla->AddRowImage('Estado','<center><img src="img/estado_doc/[estado].png" style="cursor:pointer" width="16" height="16" id="imgEstado'.$opcGrillaContable.'_[id]" /></center>','50');
	 		...
	 		if ($opcGrillaContable=='EntradaAlmacen'){
	 			$grilla->CamposBusqueda		= 'fecha_inicio,consecutivo,nit,proveedor';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
				$grilla->DivActualiBusqueda = '' ;				//VARIABLE QUE DEFINE LA CAPA DONDE SE ACTUALIZA LA GRILLA DESPUES DE UNA BUSQUEDA

	 			$grilla->AddRow('Consecutivo','consecutivo',90);
	 			$grilla->AddRow('Unidades por Facturar','pendientes_facturar',100);
	 		}
	 		else{
	 			$grilla->CamposBusqueda		= 'fecha_inicio,consecutivo,nit,proveedor';		//VARIABLE QUE DEFINE LOS CAMPOS DE LA BD DONDE SE BUSCARA
				$grilla->DivActualiBusqueda = '' ;				//VARIABLE QUE DEFINE LA CAPA DONDE SE ACTUALIZA LA GRILLA DESPUES DE UNA BUSQUEDA
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			...
			if('<?php echo $opcGrillaContable; ?>'=='EntradaAlmacen') {
	        	titulo='Entrada de Almacen';
	        	if(estado == 'img/estado_doc/0.png'){ direccionRender = 'entrada_almacen/grillaContable.php'; }
	        }
	        else if('<?php echo $opcGrillaContable; ?>'=='RequisicionCompra') {
	        	titulo='Requisicion';
