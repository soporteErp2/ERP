...
<script>
	...
	function createUploader(){ console.log('<?php echo $id_comprobante_egreso; ?>');
		var uploader = new qq.FileUploader({
            element	 	:  document.getElementById('fileuploader'),
            action 		: 'comprobante_egreso/guarda_archivo_adjunto.php',
            debug		: true,
			params		:
			{
			...
			onComplete	: function(id, fileName, responseJSON){
								...
								table.innerHTML = table.innerHTML+'<tr id="archivo_adjunto_'+RespJson.idRow+'">'+
																		...
																		'<td><img src="img/view.png" title="Ver Archivo" onclick="ver_documento_comprobante_egreso(\''+RespJson.idRow+'\',\''+RespJson.filename+'\',\''+RespJson.ext+'\')"></td>'+
																		'<td><img src="img/delete_file.png" title="Eliminar Archivo" onclick="eliminarArchivoAdjuntoComprobanteEgreso(\''+RespJson.idRow+'\',\''+RespJson.filename+'.'+RespJson.ext+'\')" ></td>'+
																	'</tr>';
