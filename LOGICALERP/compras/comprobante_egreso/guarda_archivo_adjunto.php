<?php
    ...
    class qqFileUploader {
        ...
        function handleUpload($uploadDirectory, $link, $id_comprobante_egreso,$id_empresa,$id_usuario,$id_tercero){
            ...
            $sqlInsert = "INSERT INTO comprobante_egreso_archivos_adjuntos (id_comprobante_egreso,nombre_archivo,ext,fecha_creacion,id_empresa,id_tercero,id_usuario)
                            VALUES ($id_comprobante_egreso,'$filename','$ext',now(),'$id_empresa',$id_tercero,'$id_usuario')";
    ...
    $ruta3 = $serv.'ARCHIVOS_PROPIOS/empresa_'.$id_host.'/compras/comprobante_egreso';
    $url   = $ruta3.'/';
    if(!file_exists($ruta3)){ mkdir ($ruta3); }

    $uploader = new qqFileUploader($allowedExtensions, $sizeLimit);
    $result   = $uploader->handleUpload($url, $link, $id_comprobante_egreso,$_SESSION['EMPRESA'],$_SESSION['IDUSUARIO'],$id_tercero);
