<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//NOMBRE DE LA GRILLA
			$grilla->GrillaName	 		= 'centroCostosOc';  	//NOMBRE DE LA GRILLA (DEBE SER UNICO POR CADA GRILLA DE LA APLICACION)
		//QUERY
...
if(!isset($opcion)){  ?>
	<script>
		...
		function Agregar_centroCostosOc(){ }
		function Editar_centroCostosOc(id){
			var nombre = document.getElementById('div_centroCostosOc_nombre_'+id).innerHTML
			,	codigo = document.getElementById('div_centroCostosOc_codigo_'+id).innerHTML;
			...
			Ext.Ajax.request({
			    ...
			    success :function (result, request){
							...
							document.getElementById('id_ccos_oc').value = id;
							document.getElementById('codigo_ccos_oc').value = codigo;
							document.getElementById('nombre_ccos_oc').value = nombre;
							Win_Ventana_Ccos_oc.close();
			            },
