<?php
    ...
    class qqFileUploader {
        ...
        function handleUpload($uploadDirectory,$consecutivo,$id_empleado){
            ...
            $sqlInsertDocumento = "INSERT INTO compras_ordenes_documentos (id_orden_compra, nombre, ext, id_usuario,fecha)
                                    VALUES ('$id_orden_compra','$filename','$ext','$id_usuario',NOW())";
    ...
    $ruta3 = $serv.'ARCHIVOS_PROPIOS/empresa_'.$id_host.'/compras/ordenes_compra';
    $url   = $ruta3.'/';
