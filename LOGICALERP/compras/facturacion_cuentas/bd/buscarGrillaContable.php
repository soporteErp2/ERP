<?php
	...
	//CONFIGURACION//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//QUERY
			...
			$grilla->MyWhere			= "activo = 1 AND id_sucursal=$id_sucursal AND id_empresa=$id_empresa AND factura_por_cuentas='true'
...
if(!isset($opcion)){  ?>
	...
	<script>
		function Editar_<?php echo $opcGrillaContable; ?>(id){
			var direccionRender = 'facturacion_cuentas/bd/grillaContableBloqueada.php'
			...
			if(estado == 'img/estado_doc/0.png'){ direccionRender = 'facturacion_cuentas/grilla/grillaContable.php'; }
			if(estado == 'img/estado_doc/3.png' ){
 				document.getElementById('titleDocumentoFacturaCompraCuentas').innerHTML='<span style="color:red;text-align: center;font-size: 18px;font-weight: bold;">Consecutivo<br>N. '+consecutivo+'</span>';
 			}
			else if (consecutivo!='') { document.getElementById('titleDocumentoFacturaCompraCuentas').innerHTML='Consecutivo<br>N. '+consecutivo; }
			else{ document.getElementById('titleDocumentoFacturaCompraCuentas').innerHTML=''; }
