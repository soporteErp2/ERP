...
if(!isset($opcion)){  ?>
	<script>
		...
		function Editar_centroCostos_<?php echo $opcGrillaContable; ?>(id){
			var codigo_centro_costos = document.getElementById('div_centroCostos_<?php echo $opcGrillaContable; ?>_codigo_'+id).innerHTML
			, 	centro_costos        = document.getElementById('div_centroCostos_<?php echo $opcGrillaContable; ?>_nombre_'+id).innerHTML;

			Ext.get('renderArticuloFacturaCompraCuentas_<?php echo $cont; ?>').load({
