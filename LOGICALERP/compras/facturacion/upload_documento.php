...
<script>
	...
	function createUploader(){
		var uploader = new qq.FileUploader({
            ...
            action 		: 'facturacion/guarda_archivo_adjunto.php',
            debug		: true,
			params		:
			{
			...
			onComplete	: function(id, fileName, responseJSON){
								...
								table.innerHTML = table.innerHTML+'<tr id="archivo_adjunto_'+RespJson.idRow+'">'+
																		...
																		'<td><img src="img/view.png" title="Ver Archivo" onclick="ver_documento_factura_compra(\''+RespJson.idRow+'\',\''+RespJson.filename+'\',\''+RespJson.ext+'\')"></td>'+
																		'<td><img src="img/delete_file.png" title="Eliminar Archivo" onclick="eliminarArchivoAdjuntoFacturaCompra(\''+RespJson.idRow+'\',\''+RespJson.filename+'.'+RespJson.ext+'\')" ></td>'+
																	'</tr>';
