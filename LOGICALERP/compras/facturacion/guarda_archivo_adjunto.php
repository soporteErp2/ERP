<?php
    ...
    class qqFileUploader {
        ...
        function handleUpload($uploadDirectory, $link, $id_factura_compra,$id_empresa,$id_usuario,$id_tercero){
            ...
            $sqlInsert = "INSERT INTO compras_facturas_archivos_adjuntos (id_factura_compra,nombre_archivo,ext,fecha_creacion,id_empresa,id_tercero,id_usuario)
                            VALUES ($id_factura_compra,'$filename','$ext',now(),'$id_empresa',$id_tercero,'$id_usuario')";
    ...
    $ruta3 = $serv.'ARCHIVOS_PROPIOS/empresa_'.$id_host.'/compras/facturas';
    $url   = $ruta3.'/';
    if(!file_exists($ruta3)){ mkdir ($ruta3); }

    $uploader = new qqFileUploader($allowedExtensions, $sizeLimit);
    $result   = $uploader->handleUpload($url, $link, $id_factura_compra,$_SESSION['EMPRESA'],$_SESSION['IDUSUARIO'],$id_tercero);
